  ...
  b.widget("ui.tagit", {
    ...
    _create: function () {
      ...
      this.options.showAutocompleteOnFocus &&
        (this.tagInput.focus(function (b, d) {
          a._showAutocomplete();
        }),
        "undefined" === typeof this.options.autocomplete.minLength &&
          (this.options.autocomplete.minLength = 0));
      b.isFunction(this.options.autocomplete.source) &&
        (this.options.autocomplete.source = b.proxy(
          this.options.autocomplete.source,
          this,
        ));
      ...
      this.tagList
        ...
        .append(b('<li class="tagit-new"></li>').append(this.tagInput))
        .click(function (d) {
          var c = b(d.target);
          c.hasClass("tagit-label")
            ? ((c = c.closest(".tagit-choice")),
              c.hasClass("removed") ||
                a._trigger("onTagClicked", d, {
                  tag: c,
      ...
      if (this.options.singleField)
        if (this.options.singleFieldNode) {
          ...
          ((this.options.singleFieldNode = b(
      ...
      c ||
        this.tagList.children("li").each(function () {
          b(this).hasClass("tagit-new") ||
            (a.createTag(b(this).text(), b(this).attr("class"), !0),
            b(this).remove());
        });
      this.tagInput
        .keydown(function (c) {
          if (c.which == b.ui.keyCode.BACKSPACE && "" === a.tagInput.val()) {
            var d = a._lastTag();
            !a.options.removeConfirmation || d.hasClass("remove")
              ? a.removeTag(d)
              : a.options.removeConfirmation &&
                d.addClass("remove ui-state-highlight");
          } else
            a.options.removeConfirmation &&
              a._lastTag().removeClass("remove ui-state-highlight");
          if (
            (c.which === b.ui.keyCode.COMMA && !1 === c.shiftKey) ||
            c.which === b.ui.keyCode.ENTER ||
            (c.which == b.ui.keyCode.TAB && "" !== a.tagInput.val()) ||
              ...
              ('"' != b.trim(a.tagInput.val()).replace(/^s*/, "").charAt(0) ||
                ('"' == b.trim(a.tagInput.val()).charAt(0) &&
                  '"' ==
                    b
                      .trim(a.tagInput.val())
                      .charAt(b.trim(a.tagInput.val()).length - 1) &&
                  0 !== b.trim(a.tagInput.val()).length - 1)))
          )
            ((c.which === b.ui.keyCode.ENTER && "" === a.tagInput.val()) ||
              c.preventDefault(),
              (a.options.autocomplete.autoFocus &&
                a.tagInput.data("autocomplete-open")) ||
                (a.tagInput.autocomplete("close"),
      ...
      if (
        ...
        ((d = {
          ...
          (d.source = this.options.tagSource || d.source),
          this.tagInput
            .autocomplete(d)
            .bind("autocompleteopen.tagit", function (b, c) {
    ...
    assignedTags: function () {
      ...
      this.options.singleField
        ? ((c = b(this.options.singleFieldNode)
            .val()
    ...
    _updateSingleTagsField: function (a) {
      b(this.options.singleFieldNode)
        .val(a.join(this.options.singleFieldDelimiter))
        .trigger("change");
    },
    ...
    tagLabel: function (a) {
      return this.options.singleField
        ? b(a).find(".tagit-label:first").text()
    ...
    _effectExists: function (a) {
      return Boolean(
        b.effects &&
          (b.effects[a] || (b.effects.effect && b.effects.effect[a])),
      );
    },
    ...
    removeTag: function (a, c) {
      ...
      if (
        ...
        if (c) {
          a.addClass("removed");
          var d = this._effectExists("blind")
