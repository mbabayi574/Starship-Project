  ...
  return (
    y.extend(i.prototype, {
      ...
      slide: function (t, e) {
        ...
        if (o !== t && 1 !== this.num) {
          if (
            ((e = e || this.options.transitionDuration), this.support.transform)
          ) {
            for (
      ...
      onmouseout: function (t) {
        ...
        this.touchStart &&
          ((e = t.target),
          ((i = t.relatedTarget) && (i === e || y.contains(e, i))) ||
            this.onmouseup(t));
      },
      ...
      oncomplete: function (t) {
        ...
        i &&
          ...
          "error" === t.type
            ? (y(s).addClass(this.options.slideErrorClass),
              (this.elements[e] = 3))
            : (this.elements[e] = 2),
        ...
        for (
          ...
          ((i = a.pop()),
            ...
            (o.continuous || s < i.index) &&
              y(n[s])[i.method](o.slidePrevClass),
            (s = this.circle(i.index + 1)),
            (o.continuous || s > i.index) &&
              y(n[s])[i.method](o.slideNextClass));
      ...
      imageFactory: function (t, e) {
        ...
        if (
          ...
          for (
            ...
            i.appendChild(y.extend(this.sourcePrototype.cloneNode(!1), n[h]));
      ...
      createElement: function (t, e) {
        ...
        return (
          ...
          y(i).addClass(this.options.slideContentClass),
          i
        );
      },
      ...
      loadElement: function (t) {
        this.elements[t] ||
          (this.slides[t].firstChild
            ? (this.elements[t] = y(this.slides[t]).hasClass(
                this.options.slideErrorClass,
              )
                ? 3
                : 2)
            : ((this.elements[t] = 1),
              y(this.slides[t]).addClass(this.options.slideLoadingClass),
      ...
      getDataProperty: function (t, e) {
        ...
        if (
          ...
          if (
            /^(true|false|null|-?\d+(\.\d+)?|\{[\s\S]*\}|\[[\s\S]*\])$/.test(i)
          )
            try {
      ...
      initOptions: function (t) {
        ((this.options = y.extend({}, this.options)),
          ((t && t.carousel) ||
            ...
            y.extend(this.options, this.carouselOptions),
        ...
        videoFactory: function (t, e, i) {
          ...
          if (
            ...
            for (o = 0; o < y.length; o += 1)
              c.appendChild(C.extend(this.sourcePrototype.cloneNode(!1), y[o]));
          return (
            m && (c.src = m),
