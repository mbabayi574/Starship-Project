...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    this.moment =
      typeof options === "object" && options.moment !== undefined
        ? options.moment
        : moment;
    ...
    if (typeof options.ranges === "object") {
      for (range in options.ranges) {
        ...
        else start = this.moment(options.ranges[range][0]);

        if (typeof options.ranges[range][1] === "string")
          end = this.moment(options.ranges[range][1], this.locale.format);
        else end = this.moment(options.ranges[range][1]);
  ...
  DateRangePicker.prototype = {
    ...
    setEndDate: function (endDate) {
      ...
      if (typeof endDate === "object") this.endDate = this.moment(endDate);
    ...
    updateMonthsInView: function () {
      ...
      if (this.endDate) {
        ...
        if (
          ...
          (this.startDate.format("YYYY-MM") == first.month.format("YYYY-MM") ||
            this.startDate.format("YYYY-MM") == end.month.format("YYYY-MM")) &&
          (this.endDate.format("YYYY-MM") == first.month.format("YYYY-MM") ||
            this.endDate.format("YYYY-MM") == end.month.format("YYYY-MM"))
        ) {
          return;
        }
        ...
        if (
          first.month.format("YYYY-MM") != this.startDate.format("YYYY-MM") &&
          end.month.format("YYYY-MM") != this.startDate.format("YYYY-MM")
        ) {
          first.month = this.startDate.clone().date(2);
          end.month = this.startDate.clone().date(2).add(1, "month");
        }
    ...
    renderCalendar: function (side) {
      ...
      for (
        var i = 0, col = 0, row = 0;
        i < 42;
        i++, col++, curDate = this.moment(curDate).add(24, "hour")
      ) {
        if (i > 0 && col % 7 === 0) {
          col = 0;
          row++;
      ...
      var minDate =
        side == (this.locale.direction === "ltr" ? "left" : "right")
          ? this.minDate
          : this.startDate;
      var maxDate = this.maxDate;
      ...
      if (
        ...
        (!this.linkedCalendars ||
          side == (this.locale.direction === "ltr" ? "right" : "left") ||
          this.singleDatePicker)
      ) {
      ...
      if (!this.timePicker24Hour) {
        ...
        if (selected.hour() >= 12) {
          html +=
            ...
            am_html +
            ">" +
            this.moment.localeData().meridiem(0) +
            '</option><option value="PM" selected="selected"' +
            pm_html +
            ">" +
            this.moment.localeData().meridiem(13) +
            "</option>";
        } else {
          html +=
    ...
    clickPrev: function (e) {
      ...
      if (cal.hasClass("left")) {
        ...
        if (this.linkedCalendars) this.leftCalendar.month.subtract(1, "month");
      }
      this.updateCalendars();
    },
    ...
    clickNext: function (e) {
      ...
      if (cal.hasClass("left")) {
        ...
        if (this.linkedCalendars) this.rightCalendar.month.add(1, "month");
      } else {
