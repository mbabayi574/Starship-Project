...
var FullCalendarList = (function (exports, common) {
  ...
  var ListViewHeaderRow = /** @class */ (function (_super) {
    ...
    ListViewHeaderRow.prototype.render = function () {
      ...
      var hookProps = __assign(
        {
          ...
          sideNavLinkAttrs: common.buildNavLinkAttrs(
            this.context,
            dayDate,
            "day",
            false,
      ...
      var classNames = ["fc-list-day"].concat(
        common.getDayClassNames(dayMeta, theme),
      );
  ...
  function renderInnerContent(props) {
    return common.createElement(
      ...
      props.sideText &&
        /* not keyboard tabbable */ common.createElement(
          "a",
          __assign(
  ...
  function buildTimeContent(
    ...
    if (options.displayEventTime !== false) {
      ...
      if (eventDef.allDay) {
        ...
        if (seg.isStart) {
          timeText = common.buildSegTimeText(
            seg,
            timeFormat,
            context,
            null,
        ...
        function (nowDate, todayRange) {
          ...
          for (var dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
            ...
            if (daySegs) {
              ...
              // append a day header
              innerNodes.push(
                common.createElement(ListViewHeaderRow, {
                  key: dayStr,
                  cellId: dateHeaderId,
