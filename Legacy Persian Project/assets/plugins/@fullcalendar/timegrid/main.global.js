...
var FullCalendarTimeGrid = (function (exports, common, daygrid) {
                ...
                common.createElement(
                  ...
                  common.createElement(
                    ...
                    common.createElement(
                      "tbody",
                      null,
                      common.createElement(TimeBodyAxis, {
                        slatMetas: slatMetas,
                      }),
                    ),
                  ),
  ...
  function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
    ...
    for (; level < levelCnt; level += 1) {
      ...
      var entry = void 0;
      var searchIndex = common.binarySearch(
        entries,
        subjectEntry.span.start,
        common.getEntrySpanEnd,
      );
      ...
      return common.createElement(
        ...
        hiddenGroups.map(function (hiddenGroup) {
          ...
          return common.createElement(TimeColMoreLink, {
            key: common.buildIsoString(
              common.computeEarliestSegStart(hiddenSegs),
            ),
