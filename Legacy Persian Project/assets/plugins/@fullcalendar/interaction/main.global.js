...
var FullCalendarInteraction = (function (exports, common) {
  ...
  var ElementScrollGeomCache = /** @class */ (function (_super) {
    ...
    function ElementScrollGeomCache(el, doesListening) {
      return (
        _super.call(
          this,
          new common.ElementScrollController(el),
          doesListening,
        ) || this
      );
    }
  ...
  var WindowScrollGeomCache = /** @class */ (function (_super) {
    ...
    function WindowScrollGeomCache(doesListening) {
      return (
        _super.call(this, new common.WindowScrollController(), doesListening) ||
        this
      );
    }
        ...
        if (typeof query === "object") {
          ...
          els.push.apply(
            ...
            Array.prototype.slice.call(
              common.getElRoot(scrollStartEl).querySelectorAll(query),
            ),
          );
        }
      }
  ...
  var OffsetTracker = /** @class */ (function () {
    function OffsetTracker(el) {
      ...
      this.scrollCaches = common
        .getClippingParents(el)
        .map(function (scrollEl) {
  ...
  var HitDragging = /** @class */ (function () {
    ...
    HitDragging.prototype.processFirstCoord = function (ev) {
      ...
      if (initialHit) {
        if (this.useSubjectCenter && subjectRect) {
          var slicedSubjectRect = common.intersectRects(
            subjectRect,
            initialHit.rect,
          );
    ...
    HitDragging.prototype.prepareHits = function () {
      this.offsetTrackers = common.mapHash(
        this.droppableStore,
  ...
  var DateClicking = /** @class */ (function (_super) {
    ...
    function DateClicking(settings) {
      ...
      var hitDragging = (_this.hitDragging = new HitDragging(
        _this.dragging,
        common.interactionSettingsToStore(settings),
      ));
  ...
  var EventDragging = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
      ...
      _this.handlePointerDown = function (ev) {
        ...
        _this.relevantEvents = common.getRelevantEvents(
      ...
      _this.handleHitUpdate = function (hit, isFinal) {
        ...
        if (hit) {
          ...
          if (
            ...
            if (mutation) {
              mutatedRelevantEvents = common.applyMutationToEventStore(
                relevantEvents,
      ...
      _this.handleDragEnd = function (ev) {
        if (_this.isDragging) {
          ...
          var eventApi = new common.EventApi(
            initialContext_1,
            eventDef,
            eventInstance,
          );
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              var updatedEventApi = new common.EventApi(
                initialContext_1,
              ...
              var addedEventInstance =
                mutatedRelevantEvents_1.instances[eventInstance.instanceId];
              var addedEventApi = new common.EventApi(
                receivingContext_1,
                addedEventDef,
                addedEventInstance,
              );
      ...
      var hitDragging = (_this.hitDragging = new HitDragging(
        _this.dragging,
        common.interactionSettingsStore,
      ));
    ...
    function EventResizing(settings) {
      ...
      _this.handleHitUpdate = function (hit, isFinal, ev) {
        ...
        if (mutation) {
          ...
          interaction.mutatedEvents = mutatedRelevantEvents;
          if (
            !common.isInteractionValid(interaction, hit.dateProfile, context)
          ) {
            isInvalid = true;
            mutation = null;
            mutatedRelevantEvents = null;
        ...
        if (_this.validMutation) {
          ...
          context.emitter.trigger(
            ...
            __assign(__assign({}, eventChangeArg), {
              el: _this.draggingSegEl,
              startDelta:
                _this.validMutation.startDelta || common.createDuration(0),
              endDelta:
                _this.validMutation.endDelta || common.createDuration(0),
              jsEvent: ev.origEvent,
              view: context.viewApi,
            }),
          );
  ...
  var UnselectAuto = /** @class */ (function () {
    function UnselectAuto(context) {
      ...
      this.onDocumentPointerDown = function (pev) {
        ...
        _this.matchesEvent = !!common.elementClosest(
          downEl,
        ...
        if (hit) {
          ...
          if (_this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
            ...
            interaction.mutatedEvents =
              common.eventTupleToStore(droppableEvent);
            isInvalid = !common.isInteractionValid(
              interaction,
              hit.dateProfile,
              receivingContext,
            );
  ...
  function computeEventForDateSpan(dateSpan, dragMeta, context) {
    ...
    var _b = common.refineEventDef(defProps, context),
      refined = _b.refined,
      extra = _b.extra;
    var def = common.parseEventDef(
      refined,
      extra,
      dragMeta.sourceId,
      dateSpan.allDay,
      ...
      this.handlePointerDown = function (ev) {
        ...
        dragging.minDistance =
          minDistance != null
            ...
            : ev.isTouch
              ? 0
              : common.BASE_OPTION_DEFAULTS.eventDragMinDistance;
        dragging.delay = ev.isTouch // TODO: eventually read eventLongPressDelay instead vvv
          ? longPressDelay != null
            ? longPressDelay
            : common.BASE_OPTION_DEFAULTS.longPressDelay
          : 0;
      };
      this.handleDragStart = function (ev) {
        if (
