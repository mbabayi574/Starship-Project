...
***************************************************************************** */ var extendStatics =
  ...
  var TableView = (function (_super) {
    ...
    TableView.prototype.renderHScrollLayout = function (
      ...
      sections.push({
        ...
        key: "body",
        liquid: true,
        chunks: [{ key: "main", content: bodyContent }],
      });
      if (stickyFooterScrollbar) {
        sections.push({
          ...
          key: "footer",
          isSticky: true,
          chunks: [{ key: "main", content: common.renderScrollShim }],
        });
      }
      return common.createElement(
        common.ViewRoot,
  ...
  var TableListItemEvent = (function (_super) {
    ...
    TableListItemEvent.prototype.render = function () {
      ...
      var timeText = common.buildSegTimeText(
        props.seg,
        timeFormat,
        context,
        true,
        ...
        function (rootElRef, classNames, innerElRef, innerContent) {
          return common.createElement(
            ...
            __assign(
              ...
              common.getSegAnchorAttrs(props.seg, context),
            ),
            innerContent,
          );
        },
        ...
        function (
          ...
          return common.createElement(
            ...
            __assign(
              ...
              common.createAriaClickAttrs(handleClick),
            ),
            innerContent,
          );
        },
  ...
  var TableCell = (function (_super) {
    ...
    function TableCell() {
      ...
      _this.state = { dayNumberId: common.getUniqueDomId() };
        ...
        function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) {
          return common.createElement(
            ...
            common.createElement(
              ...
              !isDisabled &&
                common.createElement(TableCellTop, {
                  date: date,
                  dateProfile: dateProfile,
                  showDayNumber: props.showDayNumber,
    ...
    for (var i = 0; i < segs.length; i += 1) {
      ...
      if (eventHeight != null) {
        segInputs.push({
          ...
          span: { start: seg.firstCol, end: seg.lastCol + 1 },
        });
      } else {
  ...
  var TableRow = (function (_super) {
    ...
    function TableRow() {
      ...
      _this.frameElRefs = new common.RefMap();
      _this.fgElRefs = new common.RefMap();
      _this.segHarnessRefs = new common.RefMap();
      _this.rootElRef = common.createRef();
      _this.state = {
        framePositions: null,
      ...
      return common.createElement(
        ...
        props.cells.map(function (cell, col) {
          ...
          return common.createElement(TableCell, {
            ...
            fgContent: common.createElement(
              common.Fragment,
              null,
              common.createElement(common.Fragment, null, normalFgNodes),
              common.createElement(common.Fragment, null, mirrorFgNodes),
            ),
            bgContent: common.createElement(
              common.Fragment,
              null,
    ...
    TableRow.prototype.renderFillSegs = function (segs, fillType) {
          ...
          nodes.push(
            common.createElement(
              ...
              fillType === "bg-event"
                ? common.createElement(
                    common.BgEvent,
                    __assign({ seg: seg }, common.getSegMeta(seg, todayRange)),
                  )
      ...
      return common.createElement.apply(
        void 0,
        __spreadArray([common.Fragment, {}], nodes),
      );
    };
      ...
      if (!props.forPrint && props.clientWidth !== null) {
        if (isExternalSizingChange) {
          ...
          if (frameEls.length) {
            ...
            this.setState({
              framePositions: new common.PositionCache(
                originEl,
                frameEls,
                true,
                false,
  ...
  TableRow.addStateEquality({ eventInstanceHeights: common.isPropsEqual });
  ...
  var Table = (function (_super) {
    ...
    Table.prototype.render = function () {
      ...
      return common.createElement(
        "div",
        {
          ...
          style: { width: props.clientWidth, minWidth: props.tableMinWidth },
        },
        common.createElement(
          common.NowTimer,
          { unit: "day" },
    ...
    Table.prototype.prepareHits = function () {
      this.rowPositions = new common.PositionCache(
        this.rootEl,
      ...
      this.colPositions = new common.PositionCache(
        this.rootEl,
  ...
  function buildDayTableModel(dateProfile, dateProfileGenerator) {
    ...
    return new common.DayTableModel(
      daySeries,
