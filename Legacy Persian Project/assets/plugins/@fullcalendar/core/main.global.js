...
***************************************************************************** */ var extendStatics =
  ...
  function computeSmallestCellWidth(cellEl) {
    ...
    return (
      ...
      allWidthEl.getBoundingClientRect().width +
  ...
  function parseString(s) {
    ...
    if (m) {
      ...
      return {
        ...
        milliseconds:
          sign *
          ((m[3] ? parseInt(m[3], 10) : 0) * 60 * 60 * 1000 +
  ...
  function parseObject(obj) {
    var duration = {
      ...
      milliseconds:
        (obj.hours || obj.hour || 0) * 60 * 60 * 1000 +
  ...
  function computePartialFormattingOptions(options, biggestUnit) {
    ...
    for (var name_2 in options) {
      if (
        !(name_2 in STANDARD_DATE_PROP_SEVERITIES) ||
  ...
  var STANDARD_PROPS = { start: identity, end: identity, allDay: Boolean };
  ...
  var CalendarApi = (function () {
      ...
      this.batchRendering(function () {
        ...
        if (dateOrRange) {
          if (dateOrRange.start && dateOrRange.end) {
            _this.dispatch({ type: "CHANGE_VIEW_TYPE", viewType: viewType });
            _this.dispatch({
              type: "SET_OPTION",
    ...
    CalendarApi.prototype.zoomTo = function (dateMarker, viewType) {
      ...
      if (spec) {
        ...
        this.dispatch({ type: "CHANGE_DATE", dateMarker: dateMarker });
      }
    };
    ...
    CalendarApi.prototype.select = function (dateOrObj, endDate) {
      ...
      if (endDate == null) {
        if (dateOrObj.start != null) {
          ...
          selectionInput = { start: dateOrObj, end: null };
        }
      } else {
        selectionInput = { start: dateOrObj, end: endDate };
      }
      var state = this.getCurrentData();
  ...
  var EventApi = (function () {
    ...
    EventApi.prototype.setExtendedProp = function (name, val) {
      var _a;
      this.mutate({ extendedProps: ((_a = {}), (_a[name] = val), _a) });
    };
    ...
    EventApi.prototype.remove = function () {
      ...
      context.dispatch({ type: "REMOVE_EVENTS", eventStore: asStore });
      context.emitter.trigger("eventRemove", {
        event: this,
        relatedEvents: [],
        revert: function () {
          context.dispatch({ type: "MERGE_EVENTS", eventStore: asStore });
        },
      });
    };
  ...
  function organizeRawLocales(explicitRawLocales) {
    ...
    var rawLocaleMap = { en: RAW_EN_LOCALE };
    for (
  ...
  function buildEventUiForKey(allUi, eventUiForKey, individualUi) {
    ...
    var stuff = { "": combineEventUis(baseParts) };
    if (individualUi) {
  ...
  var eventSourceDef$2 = {
    ...
    fetch: function (arg, success) {
      success({ rawEvents: arg.eventSource.meta });
    },
  };
  ...
  function groupIntersectingEntries(entries) {
    ...
    for (var _i = 0, entries_2 = entries; _i < entries_2.length; _i++) {
      ...
      var filteredMerges = [];
      var hungryMerge = { span: entry.span, entries: [entry] };
  ...
  var ViewContainer = (function (_super) {
    ...
    function ViewContainer() {
      var _this = (_super !== null && _super.apply(this, arguments)) || this;
      _this.state = { availableWidth: null };
  ...
  var CalendarContent = (function (_super) {
    ...
    function CalendarContent() {
      ...
      _this.state = { viewLabelId: getUniqueDomId() };
  ...
  var TableDowCell = (function (_super) {
    ...
    TableDowCell.prototype.render = function () {
      ...
      var hookProps = __assign(
        __assign(
          __assign(__assign({ date: date }, dateMeta), { view: viewApi }),
          props.extraHookProps,
        ),
        { text: text },
      );
  ...
  var DayTableModel = (function () {
    ...
    DayTableModel.prototype.buildCell = function (row, col) {
      ...
      return { key: date.toISOString(), date: date };
    };
  ...
  function renderScrollShim(arg) {
    return createElement("div", {
      ...
      style: { width: arg.clientWidth, minWidth: arg.tableMinWidth },
    });
  }
  ...
  var SimpleScrollGrid = (function (_super) {
    ...
    SimpleScrollGrid.prototype.renderChunkTd = function (
      ...
      return createElement(
        isHeader ? "th" : "td",
        { ref: chunkConfig.elRef, role: "presentation" },
        createElement(
          "div",
          {
            className:
      ...
      function (rootElRef, classNames, innerElRef, innerContent, hookProps) {
        return createElement(
          "div",
          {
            ...
            style: { backgroundColor: hookProps.backgroundColor },
          },
          innerContent,
        );
      },
  ...
  var Popover = (function (_super) {
    ...
    function Popover() {
      var _this = (_super !== null && _super.apply(this, arguments)) || this;
      _this.state = { titleId: getUniqueDomId() };
      _this.handleRootEl = function (el) {
        _this.rootEl = el;
        if (_this.props.elRef) {
          setRef(_this.props.elRef, el);
    ...
    MorePopover.prototype.queryHit = function (
      ...
      if (
        ...
        return {
          ...
          dayEl: rootEl,
          rect: { left: 0, top: 0, right: elWidth, bottom: elHeight },
          layer: 1,
        };
      }
      return null;
  ...
  var MoreLinkRoot = (function (_super) {
    ...
    function MoreLinkRoot() {
      ...
      _this.state = { isPopoverOpen: false, popoverId: getUniqueDomId() };
  ...
  function computeRange(props) {
    if (props.allDayDate) {
      return { start: props.allDayDate, end: addDays(props.allDayDate, 1) };
    }
