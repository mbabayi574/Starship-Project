  ...
  $e("search", 1, function (t, e, i) {
    return [
      ...
      function (t) {
        ...
        var r = Ve(o, a);
        return (
          on(o.lastIndex, s) || (o.lastIndex = s),
          null === r ? -1 : r.index
        );
      },
    ];
    ...
    { target: "Array", proto: !0, forced: !Co },
    {
      splice: function (t, e) {
        ...
        if (((o.length = n), i < n)) {
          ...
          for (a = c - n; a > h; a--)
            ((r = a + i - 1),
              (s = a + n - 1) in l ? (l[r] = l[s]) : delete l[r]);
  ...
  var Ko = {
    ...
    Xo = {
      ...
      formatShowingRows: function (t, e, i, n) {
        return void 0 !== n && n > 0 && n > i
          ? "نمایش "
              .concat(t, " تا ")
              .concat(e, " از ")
              .concat(i, " ردیف (filtered from ")
              .concat(n, " total rows)")
          : "نمایش ".concat(t, " تا ").concat(e, " از ").concat(i, " ردیف");
      },
      ...
      formatNoMatches: function () {
        return "هیچ داده ای پیدا نشد";
      },
      formatPaginationSwitch: function () {
        return "مخفی/نمایش صفحه بندی";
      },
            ...
            value: function (t, e, i) {
              if (
                ...
                var n = this.$toolbar
                  ...
                  .prop("disabled", !1);
                (i &&
                  n.filter(ua.sprintf('[value="%s"]', t)).prop("checked", e),
                  n.filter(":checked").length <=
