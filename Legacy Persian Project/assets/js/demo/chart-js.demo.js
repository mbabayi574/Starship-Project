      ...
      datasets: [
        {
          ...
          backgroundColor: [
            ...
            "rgba(" + app.color.whiteRgb + ", .2)" + ", .5)",
            "rgba(" + app.color.gray300Rgb + ", .5)",
            "rgba(" + app.color.gray500Rgb + ", .5)",
            "rgba(" + app.color.gray800Rgb + ", .5)",
          ],
          borderWidth: 0,
        },
      ],
      ...
      datasets: [
        {
          ...
          hoverBackgroundColor: [
            ...
            "rgba(" + app.color.whiteRgb + ", 1)",
            "rgba(" + app.color.gray900Rgb + ", 1)",
          ],
          borderWidth: 0,
        },
      ],
