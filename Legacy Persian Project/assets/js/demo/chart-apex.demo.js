...
var handleRenderApexChart = function () {
  ...
  var apexPieChartOptions = {
    ...
    colors: [
      hexToRgba(app.color.pink, 0.75),
      hexToRgba(app.color.orange, 0.75),
      hexToRgba(app.color.theme, 0.75),
      "rgba(" + app.color.whiteRgb + ", .5)",
      hexToRgba(app.color.indigo, 0.75),
    ],
    ...
    plotOptions: {
      radar: {
        ...
        polygons: {
          ...
          fill: {
            colors: [
              hexToRgba(app.color.gray300, 0.25),
...
$(document).ready(function () {
  ...
  $(document).on("theme-reload", function () {
    $(
      "#apexLineChart, #apexColumnChart, #apexAreaChart, #apexBarChart, #apexMixedChart, #apexCandlestickChart, #apexBubbleChart, #apexScatterChart, #apexHeatmapChart, #apexPieChart, #apexRadialBarChart, #apexRadarChart",
    ).empty();
