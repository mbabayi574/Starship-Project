      ...
      <div className="row" data-masonry='{"percentPosition": true }'>
              ...
              <div>
                <div className="row mb-2">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-theme">+</span> 25%
                  </div>
                </div>
                <div className="row mb-2">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-danger">-</span> 5.2%
                  </div>
                </div>
                <div className="row mb-2">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-theme">+</span> 2.3%
                  </div>
                </div>
                <div className="row mb-2">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-theme">+</span> 4.9%
                  </div>
                </div>
                <div className="row">
        ...
        <div className="col-lg-6 col-xl-4 mb-4">
          <Card>
            <CardBody>
              <div className="d-flex align-items-center mb-2">
                <div className="flex-fill fs-16px fw-bold">
            ...
            <CardBody>
              ...
              <div>
                ...
                <div className="row mb-2">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-danger">-</span> 5%
                  </div>
                </div>
                <div className="row mb-2">
                  <div className="col-6">
                  ...
                  <div className="col-3 text-center">
                    <span className="text-theme">+</span> 82%
                  </div>
                </div>
                <div className="row">
                  <div className="col-6">
                ...
                <div className="col-6">
                  <div>
                    <a
                      ...
                      className="text-decoration-none text-inverse text-opacity-50"
                    >
                      /phone/apple-11-pro-max
                    </a>
                  </div>
                </div>
                <div className="col-3 text-center">15</div>
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 15%
                </div>
              </div>
              <div className="row mb-2">
                <div className="col-6">
                  <div>
                    <a
                      ...
                      className="text-decoration-none text-inverse text-opacity-50"
                    >
                      /tablet/apple-ipad-pro-128gb
                    </a>
                  </div>
                </div>
                <div className="col-3 text-center">12</div>
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 8%
                </div>
              </div>
              <div className="row">
                <div className="col-6">
                ...
                <div className="col-3 text-center">
                  <span className="text-danger">-</span> 3%
                </div>
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody>
              ...
              <div className="row mb-2">
                ...
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 4.2%
                </div>
              </div>
              <div className="row mb-2">
                <div className="col-6">
              ...
              <div className="row">
                ...
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 8.9%
                </div>
              </div>
            </CardBody>
          </Card>
        ...
        <div className="col-lg-6 col-xl-4 mb-4">
          <Card>
            <CardBody>
              <div className="d-flex align-items-center mb-3">
                <div className="flex-fill fw-600 fs-16px">
              ...
              <div className="row mb-2">
                ...
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 8.2%
                </div>
              </div>
              <div className="row mb-2">
                <div className="col-6">
                ...
                <div className="col-3 text-center">
                  <span className="text-danger">-</span> 3.4%
                </div>
              </div>
              <div className="row mb-2">
                <div className="col-6">
                ...
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 1.9%
                </div>
              </div>
              <div className="row">
                <div className="col-6">
                ...
                <div className="col-3 text-center">
                  <span className="text-theme">+</span> 2.1%
                </div>
              </div>
            </CardBody>
          </Card>
