...
function PosCounterCheckout() {
  ...
  useEffect(() => {
    ...
    fetch("/assets/data/pos/counter-checkout.json")
      .then((res) => res.json())
      .then((result) => {
        setTableData(result);
      });
                          ...
                          <Card
                            className={
                              ...
                              table.tableNo === selectedTable.tableNo
                                ? " selected"
                                : "") +
                              (!table.orders && table.status !== "Reserved"
                                ? " available"
                                : "") +
                              (table.orders ? " in-use" : "") +
                              ...
                              <div className="pos-checkout-table-header">
                                ...
                                <div className="text-inverse text-opacity-50">
                                  ...
                                  {table.status === "Reserved" && (
                                    <span>
                                      Reserved for {table.reserveName}
                                    </span>
                                  )}
                                  {!table.orders &&
                                    table.status !== "Reserved" && (
                                ...
                                <div className="row">
                                  <div className="col-6 d-flex justify-content-center">
                                    <div className="w-20px">
                                      <i className="bi bi-people text-inverse text-opacity-50"></i>
                                    </div>
                                    <div className="w-60px">
                                      {table.pax} / {table.totalPax}
                                    </div>
                                  </div>
                                  <div className="col-6 d-flex justify-content-center">
                                    <div className="w-20px">
                                      <i className="bi bi-clock text-inverse text-opacity-50"></i>
                                    </div>
                                    <div className="w-60px">
                                      {table.totalTime ? table.totalTime : "-"}
                                    </div>
                                  </div>
                                </div>
                                <div className="row">
                                  <div className="col-6 d-flex justify-content-center">
                                    <div className="w-20px">
                                      <i className="bi bi-receipt text-inverse text-opacity-50"></i>
                                    </div>
                                    <div className="w-60px">
                                      ${getTotalPrice(table.orders)}
                                    </div>
                                  </div>
                                  <div className="col-6 d-flex justify-content-center">
                                    <div className="w-20px">
                                      <i className="bi bi-currency-dollar text-inverse text-opacity-50"></i>
                                    </div>
                                    <div
                                      className={
                                        "w-60px" +
                ...
                <div className="pos-sidebar-header">
                  ...
                  <div className="order">
                    ...
                    <b className="text-theme">
                      #
                      {selectedTable && selectedTable.orderNo
                        ? selectedTable.orderNo
                        : "-"}
                    </b>
                  </div>
                </div>
                ...
                <PerfectScrollbar className="pos-sidebar-body">
                  <div>
                    {selectedTable && selectedTable.orders ? (
                          ...
                          <div className="pos-order-product">
                            ...
                            <div className="flex-1">
                              <div className="row">
                                ...
                                <div className="col-3 text-inverse fw-bold text-end">
                                  $
                                  {(
                      ...
                      <div className="pos-order py-3">No records found</div>
                    )}
                  </div>
                </PerfectScrollbar>
                ...
                <div className="pos-sidebar-footer">
                  ...
                  <div className="mt-3">
                    <div className="btn-group d-flex">
                      ...
                      >
                        <i className="bi bi-paypal fa-lg"></i>
                        <br />
                      ...
                      <a
                        ...
                        className="btn btn-outline-default rounded-0 w-80px"
                      >
                        <i className="bi bi-credit-card fa-fw fa-lg"></i>
                        <br />
                      ...
                      >
                        <i className="bi bi-wallet2 fa-lg"></i>
                        <br />
