    ...
    <Card className="pos pos-vertical" id="pos">
      <CardBody className="pos-container">
        ...
        <div className="pos-content">
          <div
            className="pos-content-container h-100 p-3"
            data-scrollbar="true"
            data-height="100%"
          >
            <div className="row gx-3">
              {stockData && stockData.length > 0 ? (
                stockData.map((stock, index) => (
                  <div
                    className="col-xl-2 col-lg-3 col-md-4 col-sm-6 pb-3"
                    key={stock.id}
                  >
                      ...
                      <CardBody className="h-100 p-1">
                        <div className="pos-product">
                          ...
                          <div className="info">
                            ...
                            <div className="desc text-truncate">
                              {stock.description}
                            </div>
                              ...
                              <div className="flex-1">
                                <div className="form-check form-switch">
                                  <input
                                    ...
                                    name="qty"
                                    id="product1"
                                    defaultChecked={stock.available}
                                    defaultValue="1"
                                  />
                                  <label
                            ...
                            <div>
                              ...
                              <a href="#/" className="btn btn-default d-block">
