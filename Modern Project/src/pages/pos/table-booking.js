...
function PosTableBooking() {
  ...
  function checkSameHour(time) {
    ...
    var currentHour =
      currentFullHour > 12 ? currentFullHour - 12 : currentFullHour;
    ...
    if (tableData) {
      for (var i = 0; i < tableData.length; i++) {
        for (var x = 0; x < tableData[i].reservation.length; x++) {
          if (
            tableData[i].reservation[x].time === currentHour &&
            !tableData[i].reservation[x].text
          ) {
            count++;
          }
        }
              ...
              <div className="d-md-flex align-items-center mb-4">
                <div className="flex-1">
                  <div className="fs-24px mb-1">
                    Available Table ({getAvailableTable()}/20)
                  </div>
                  <div className="mb-2 mb-md-0 d-flex">
                    <div className="d-flex align-items-center me-3">
                      <i className="fa fa-circle fa-fw text-inverse text-opacity-25 fs-9px me-1"></i>{" "}
                      Completed
                    </div>
                    <div className="d-flex align-items-center me-3">
                      <i className="fa fa-circle fa-fw text-warning fs-9px me-1"></i>{" "}
                      Upcoming
                    </div>
                    <div className="d-flex align-items-center me-3">
                      <i className="fa fa-circle fa-fw text-success fs-9px me-1"></i>{" "}
                      In-progress
                    </div>
                  </div>
                </div>
                <div>
                  <div
                    className="input-group date mb-0"
                          ...
                          <div className="pos-table-booking-container">
                            ...
                            <div className="pos-table-booking-body">
                              {table.reservation.length > 0 ? (
                                table.reservation.map((reservation, index) => (
                                  <div
                                    className={
                                      "booking" +
                                      (checkSameHour(reservation.time)
                                        ? " highlight"
                                        : "")
                                    }
                                    key={index}
            ...
            <Card>
              <CardBody className="p-0">
                <div className="modal-header align-items-center">
                  <h5 className="modal-title d-flex align-items-end">
                    <img
                      ...
                      alt=""
                      height="25"
                      className="invert-dark me-2 opacity-5"
                    />
                    Table 01
                    <small className="fs-14px ms-2 text-inverse text-opacity-50">
                      max 4 pax
                    </small>
                  </h5>
                  <button data-bs-dismiss="modal" className="ms-auto btn-close">
                    &nbsp;
                  </button>
                </div>
                    ...
                    <div className="col-lg-6">
                      <div className="form-group mb-2">
                        <div className="input-group">
                          <div className="input-group-text fw-bold w-90px fs-13px">
                            08:00am
                          </div>
                          <input
                            type="text"
                      ...
                      <div className="form-group mb-2">
                        <div className="input-group">
                          ...
                          <input
                            ...
                            className="form-control"
                            placeholder=""
                            defaultValue="Reserved by Irene Wong (4pax)"
                          />
                        </div>
                      </div>
                      <div className="form-group mb-2">
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn btn-success w-100px">
                    Book
                  </button>
                </div>
              </CardBody>
