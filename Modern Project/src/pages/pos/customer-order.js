  ...
  var getSubTotalPrice = () => {
    ...
    if (orderData) {
      for (var i = 0; i < orderData.length; i++) {
        value +=
          parseFloat(orderData[i].price) * parseInt(orderData[i].quantity);
      }
    }
          ...
          <div className="pos-sidebar" id="pos-sidebar">
            <div className="h-100 d-flex flex-column p-0">
              <div className="pos-sidebar-header">
                ...
                <div className="title">
                  Table {tableData && tableData.tableNo && tableData.tableNo}
                </div>
                <div className="order">
                  Order:{" "}
              ...
              <div className="pos-sidebar-footer">
                ...
                <div className="mt-3">
                  <div className="btn-group d-flex">
                    ...
                    <button className="btn btn-outline-default rounded-0 w-80px">
                      <i className="bi bi-receipt fa-fw fa-lg"></i>
                      <br />
