          ...
          <PerfectScrollbar className="pos-content-container h-100 p-0">
              ...
              orderData.map((order, index) => (
                <div className="pos-task" key={index}>
                  <div className="pos-task-info">
                    ...
                    {order.orderTime && (
                      <div
                        className={order.urgent ? "text-danger fw-bold" : ""}
                      >
                        {order.orderTime} time
                      </div>
                    )}
                    {order.totalOrderTime && (
                      <div>
                        All dish served
                        <br />
                        {order.totalOrderTime} total time
                      </div>
                    )}
                  </div>
            ...
            <div className="pos-task">
              <div className="pos-task-info">
                ...
                <div className="mb-2">
                  <span className="badge bg-success text-black fs-14px">
                    Dine-in
                  </span>
                </div>
                <div>
              ...
              <div className="pos-task-body">
                <div className="fs-16px mb-3">Completed: (3/4)</div>
                <div className="row gx-4">
                    ...
                    <div className="pos-task-product">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-11.jpg)",
                          }}
                        ></div>
                      </div>
                      <div className="pos-task-product-info">
                    ...
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-12.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                      ...
                      <div className="pos-task-product-info">
                        <div className="flex-1">
                          ...
                          <div>
                            - size: large <br />- spicy level: light
                          </div>
                        </div>
                      </div>
                      <div className="pos-task-product-action">
                    ...
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-7.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
            ...
            <div className="pos-task">
              <div className="pos-task-info">
                ...
                <div className="mb-2">
                  <span className="badge bg-gray-500 text-inverse fs-14px">
                    Dine-in
                  </span>
                </div>
                <div>
              ...
              <div className="pos-task-body">
                <div className="fs-16px mb-3">Completed: (3/3)</div>
                <div className="row gx-4">
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
            ...
            <div className="pos-task">
              ...
              <div className="pos-task-body">
                <div className="fs-16px mb-3">Completed: (2/2)</div>
                <div className="row gx-4">
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-13.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                    ...
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-9.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                    ...
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-4.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                    ...
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(/assets/img/pos/product-6.jpg)",
                          }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
