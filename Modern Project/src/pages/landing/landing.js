      ...
      <div id="header" className="app-header navbar navbar-expand-lg p-0">
        <div className="container-xxl px-3 px-lg-5">
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            <div className="navbar-nav ms-auto mb-2 mb-lg-0 text-uppercase small fw-semibold">
              <div className="nav-item me-2">
                <a href="#home" className="nav-link link-body-emphasis">
                  Home
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#about" className="nav-link link-body-emphasis">
                  About
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#features" className="nav-link link-body-emphasis">
                  Features
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#pricing" className="nav-link link-body-emphasis">
                  Pricing
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#testimonials" className="nav-link link-body-emphasis">
                  Testimonials
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#blog" className="nav-link link-body-emphasis">
                  Blog
                </a>
              </div>
              <div className="nav-item me-2">
                <a href="#contact" className="nav-link link-body-emphasis">
                  Contact
                </a>
              </div>
            </div>
          ...
          <div className="ms-3">
            ...
            >
              Get started <i className="fa fa-arrow-right ms-1"></i>
            </Link>
          </div>
        </div>
      </div>
      ...
      >
        <div className="container-xxl p-3 p-lg-5 mb-0">
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <div className="fs-18px text-body text-opacity-75 mb-4">
                  Join thousands of users worldwide who rely on HUD Template{" "}
                  <span className="d-xl-inline d-none">
                    <br />
                  </span>
                  to kickstart their startups, enhance company projects, hone
                  creative skills,{" "}
                  <span className="d-xl-inline d-none">
                    <br />
                  </span>
                ...
                <div className="mb-2">
                  <Link to="/" className="btn btn-lg btn-outline-white px-3">
                    Discover Our Template{" "}
                    <i className="fa fa-arrow-right ms-2 opacity-5"></i>
                  </Link>
                </div>
                ...
                <div className="row text-body mt-4 mb-4">
                  <div className="col-6 mb-3 mb-lg-0">
                    <div className="d-flex align-items-center">
                      <div className="h1 text-body text-opacity-25 me-3">
                        <Icon icon="bi:download" />
                      </div>
                      <div>
                        <div className="fw-500 mb-0 h3">1.8k+</div>
                        <div className="fw-500 text-body text-opacity-75">
                          Downloads / Purchases
                        </div>
                      </div>
                    </div>
          ...
          <div className="position-absolute top-0 bottom-0 end-0 w-50 p-5 z-2 overflow-hidden d-lg-flex align-items-center d-none">
            <img
              className="w-100 d-block shadow-lg"
              alt="HUD"
        ...
        <div
          className="position-absolute bg-size-cover bg-position-center d-none2 bg-no-repeat top-0 start-0 w-100 h-100"
          style={{ backgroundImage: "url(/assets/img/landing/cover.jpg)" }}
        ></div>
        <div
          className="position-absolute top-0 start-0 d-none2 w-100 h-100 opacity-95"
          style={{ background: "var(--bs-body-bg-gradient)" }}
        ></div>
        <div
          className="position-absolute top-0 start-0 d-none2 w-100 h-100 opacity-95"
          style={{
            backgroundImage: "url(/assets/css/images/pattern-dark.png)",
            backgroundSize: "var(--bs-body-bg-image-size)",
          }}
        ></div>
      </div>
      ...
      <div id="about" className="py-5 bg-component">
        <div className="container-xxl p-3 p-lg-5 text-center">
          ...
          <p className="fs-16px text-body text-opacity-50 mb-5">
            ...
            developers, designers, and entrepreneurs, enabling effortless
          ...
          <div className="row text-start g-3 gx-lg-5 gy-lg-4">
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
              ...
              <div className="flex-1 ps-3">
                ...
                <p className="mb-0">
                  Optimized for all devices, ensuring a seamless and exceptional
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
              ...
              <div className="flex-1 ps-3">
                ...
                <p className="mb-0">
                  Modify layouts, colors, and more with ease. HUD Template
                  offers unparalleled flexibility to adapt to your specific
                  needs.
                </p>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
              ...
              <div className="flex-1 ps-3">
                ...
                <p className="mb-0">
                  Fast loading times and efficient coding practices ensure a
                  smooth user experience, even under heavy traffic.
                </p>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
              ...
              <div className="flex-1 ps-3">
                <h4>Secure</h4>
                <p className="mb-0">
                  Built with security in mind, protecting your data and ensuring
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
              ...
              <div className="flex-1 ps-3">
                ...
                <p className="mb-0">
                  Flexible and scalable infrastructure to meet diverse business
                  needs, ensuring reliability and performance.
                </p>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6 d-flex">
      ...
      <div id="pricing" className="py-5 text-body text-opacity-75">
        <div className="container-xxl p-3 p-lg-5">
          ...
          <p className="fs-16px text-body text-opacity-50 text-center mb-0">
            Choose the perfect plan that suits your needs. <br />
            Our pricing is designed to be flexible and affordable, providing
            value for businesses of all sizes. <br />
            Explore our plans to find the best fit for your requirements.
          </p>
                ...
                <CardBody className="p-4 d-flex flex-column">
                  <div className="d-flex align-items-center">
                    <div className="flex-1">
                      ...
                      <div className="h1 fw-semibold mb-0">
                        $5{" "}
                        <small className="h6 fw-semibold text-body text-opacity-50">
                          /month*
                        </small>
                      </div>
                    </div>
                    <div>
                      <Icon
                        ...
                        className="display-6 text-body text-opacity-50"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5 text-body text-opacity-75 flex-1">
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        <span className="font-monospace small">Storage:</span>{" "}
                        <b className="text-body">10 GB</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check fa-lg text-theme"></i>
                      <div className="flex-1 ps-3">
                        <span className="font-monospace small">Bandwidth:</span>{" "}
                        <b className="text-body">100 GB</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check fa-lg text-theme"></i>
                    ...
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body"> Shared</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check fa-lg text-theme"></i>
                    ...
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body"> Yes</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-times fa-lg text-body text-opacity-25"></i>
                      <div className="flex-1 ps-3">
                        <span className="font-monospace small">Backup:</span>{" "}
                        <b className="text-body"> Daily</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-times fa-lg text-body text-opacity-25"></i>
                    ...
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body"> cPanel</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-times fa-lg text-body text-opacity-25"></i>
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body"> No</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-times fa-lg text-body text-opacity-25"></i>
                      <div className="flex-1 ps-3">
                        <span className="font-monospace small">Firewall:</span>{" "}
                        <b className="text-body"> No</b>
                      </div>
                    </div>
                  </div>
                  <div className="mx-n2">
                    <a
                      href="#/"
                      className="btn btn-outline-default btn-lg w-100 font-monospace"
                    >
                ...
                <CardBody className="p-4 d-flex flex-column">
                  ...
                  <div className="mb-5 text-body text-opacity-75 flex-1">
                    ...
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        <span className="font-monospace small">Bandwidth:</span>{" "}
                        <b className="text-body">200 GB</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check fa-lg text-theme"></i>
            ...
            <div className="col-xl-3 col-md-6 py-3 py-xl-0">
              <Card className="border-theme h-100">
                <CardBody className="p-30px h-100 d-flex flex-column">
                  <div className="d-flex align-items-center">
                    <div className="flex-1">
                      <div className="h6 font-monospace text-theme">
                        Premium Plan
                      </div>
                      <div className="display-6 fw-bold mb-0 text-theme">
                        $15{" "}
                        <small className="h6 text-body text-opacity-50">
                          /month*
                        </small>
                      </div>
                    </div>
                    <div>
                      <Icon
                        ...
                        className="display-5 text-theme"
                      />
                    </div>
                  </div>
                  <hr className="my-20px" />
                  <div className="mb-5 text-body flex-1">
                    <div className="d-flex align-items-center mb-1">
                      ...
                      <div className="flex-1 ps-3">
                        <span className="font-monospace text-body text-opacity-50 small">
                          Storage:
                        </span>{" "}
                        <b className="text-body">50 GB</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check text-theme fa-lg"></i>
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body">500 GB</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check text-theme fa-lg"></i>
                      <div className="flex-1 ps-3">
                        ...
                        <b className="text-body">Unlimited</b>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-1">
                      <i className="fa fa-check text-theme fa-lg"></i>
                  ...
                  <a
                    href="#/"
                    className="btn btn-theme btn-lg w-100 text-black font-monospace"
                  >
                    Get Started <i className="fa fa-arrow-right"></i>
                  </a>
                </CardBody>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <Icon
                        ...
                        className="display-6 text-white text-opacity-50"
                      />
                    </div>
                  </div>
                  <hr className="my-20px" />
        ...
        <div className="container-xxl p-3 p-lg-5">
          <div className="text-center mb-5">
            ...
            <p className="fs-16px text-body text-opacity-50 text-center mb-0">
              ...
              Discover how HUD Admin Template enhances productivity and exceeds
              expectations <br />
              ...
              <Card className="p-4 h-100">
                <div className="d-flex align-items-center mb-3">
                  <img
                    ...
                    className="rounded-circle me-3 w-50px"
                    alt="Client 1"
                  />
                  <div>
                ...
                <div className="d-flex">
                  ...
                  <div className="p-3">
                    ...
                    HUD Admin Template transformed our workflow. The
                    customization options are unparalleled, and the support team
              ...
              <Card className="p-4 h-100">
                ...
                <div className="d-flex">
                  ...
                  <div className="p-3">
                    ...
                    The features are top-notch, and the user experience is
                    outstanding.
                  </div>
                  <div className="d-flex align-items-end">
                    <i className="fa fa-quote-right fa-2x text-body text-opacity-15"></i>
              ...
              <Card className="p-4 h-100">
                ...
                <div className="d-flex">
                  ...
                  <div className="p-3">
                    ...
                    This template is a game-changer. It's intuitive, flexible,
                    and the seamless integration has made our projects run
                    smoother than ever.
                  </div>
                  <div className="d-flex align-items-end">
                    <i className="fa fa-quote-right fa-2x text-body text-opacity-15"></i>
              ...
              <Card className="p-4 h-100">
                ...
                <div className="d-flex">
                  ...
                  <div className="p-3">
                    ...
                    HUD Admin Template has exceeded all our expectations. The
                    advanced features and excellent support make it a standout
                    choice.
                  </div>
                  <div className="d-flex align-items-end">
                    <i className="fa fa-quote-right fa-2x text-body text-opacity-15"></i>
      ...
      <div id="blog" className="py-5 bg-component">
        <div className="container-xxl p-3 p-lg-5">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <Card className="d-flex flex-column h-100 mb-5 mb-lg-0">
                ...
                <div className="flex-1 px-3 pb-0">
                  <div className="mb-2">
                    <span className="bg-theme bg-opacity-15 text-theme px-2 py-1 rounded small fw-bold">
                      Web Design
                    </span>
                  </div>
                  ...
                  <p>
                    ...
                    essential tips to create websites that look great on any
                    device.
                  </p>
                </div>
                <div className="p-3 pt-0 text-body text-opacity-50">
                  July 15, 2025
                </div>
              </Card>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <Card className="d-flex flex-column h-100 mb-5 mb-lg-0">
                ...
                <div className="flex-1 p-3 pb-0">
                  ...
                  <p>
                    Discover the latest trends shaping user interface and
                    experience design in the digital landscape this year.
                  </p>
                </div>
                <div className="p-3 pt-0 text-body text-opacity-50">
                  July 11, 2025
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <Card className="d-flex flex-column h-100 mb-5 mb-lg-0">
                ...
                <div className="flex-1 p-3 pb-0">
                  ...
                  <h5>
                    Security Essentials: Protecting Your Website from Cyber
                    Threats
                  </h5>
                  <p>
                    Essential security measures and best practices to safeguard
                    your website and user data from cyber threats.
                  </p>
                </div>
                <div className="p-3 pt-0 text-body text-opacity-50">
                  June 27, 2025
          ...
          <div className="text-center">
            <a
              href="#/"
              className="text-decoration-none text-body text-opacity-50 h6"
            >
        ...
        <div className="container-xl p-3 p-lg-5">
          ...
          <div className="row gx-3 gx-lg-5">
            <div className="col-lg-6">
              ...
              <p>
                Do you have a project in mind? We’re eager to discuss it with
                you. Whether you’re looking for advice, have questions, or want
                to share your ideas, feel free to reach out.
              </p>
              <p>
                <span className="fw-bolder">SeanTheme HUD, Inc</span>
                <br />
              ...
              <form action="" method="GET" name="form_contact_us">
                <div className="row gy-3 mb-3">
                  ...
                  <div className="col-12">
                    <button
                      type="submit"
                      className="btn btn-outline-theme btn-lg btn-block px-4 fs-15px"
                    >
                      Send Message
                    </button>
                  </div>
        ...
        <div className="container-xxl px-3 px-lg-5">
          <div className="row gx-lg-5 gx-3 gy-lg-4 gy-3">
            <div className="col-lg-3 col-md-6">
              ...
              <p className="mb-4">
                HUD is your go-to solution for creating stunning, responsive,
                and high-performance web applications. Designed for developers,
                designers, and entrepreneurs, it provides the tools and
                flexibility needed to bring your creative visions to life.
              </p>
              <h5>Follow Us</h5>
              <div className="d-flex">
                <a href="#/" className="me-2 text-body text-opacity-50">
                  <i className="fab fa-lg fa-facebook fa-fw"></i>
                </a>
                <a href="#/" className="me-2 text-body text-opacity-50">
                  <i className="fab fa-lg fa-instagram fa-fw"></i>
                </a>
                <a href="#/" className="me-2 text-body text-opacity-50">
                  <i className="fab fa-lg fa-twitter fa-fw"></i>
                </a>
                <a href="#/" className="me-2 text-body text-opacity-50">
                  <i className="fab fa-lg fa-youtube fa-fw"></i>
                </a>
                <a href="#/" className="me-2 text-body text-opacity-50">
                  <i className="fab fa-lg fa-linkedin fa-fw"></i>
                </a>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
          ...
          <div className="row">
            ...
            <div className="col-sm-6 text-sm-end">
              <div className="dropdown me-4 d-inline">
                <a
                  href="#/"
                  className="text-decoration-none dropdown-toggle text-body text-opacity-50"
              ...
              <a
                href="#/"
                className="text-decoration-none text-body text-opacity-50"
              >
                Sitemap
              </a>
            </div>
