    ...
    if (e && e.currentTarget && tabActive === "aiChatPrev") {
      ...
      if (targetDiv) {
        setTimeout(() => {
          ...
          let prevTabs = document.querySelectorAll(
            '[data-toggle-ai-tab="aiChatPrev"]',
          );
          prevTabs.forEach((el) => {
  ...
  return (
    <Card className="h-100" style={{ zIndex: "1020" }}>
      <div className="d-flex h-100">
        <a
          className="d-lg-none btn btn-lg bg-inverse bg-opacity-15 bg-blur-2 text-body rounded-0 z-3 ms-1px mt-5 shadow-lg position-absolute top-0 start-0 "
        ...
        <div
          className="w-300px offcanvas offcanvas-start bg-none position-lg-relative transform-lg-none visibility-lg-initial z-lg-3"
          id="aiChatSidebar"
        >
          ...
          <div className="position-relative h-100 d-flex flex-column">
            <div className="p-3">
              <button
                type="button"
                className="btn btn-outline-theme w-100 rounded-3 py-2 d-flex align-items-center justify-content-center"
                onClick={(e) => {
                  e.preventDefault();
                  toggleAiTab(e, "aiChatIntro");
                }}
              >
                New Chat
              </button>
              ...
              <PerfectScrollbar className="p-3 h-100">
                <div className="fw-500 mb-1 d-flex align-items-center">
                  <Icon
                    ...
                    className="fs-16px me-8px mt-n1 text-theme"
                  ></Icon>
                  Today
                </div>
                <div className="px-2">
                  <div className="position-relative hover-bg-light bg-opacity-25 hover-show rounded-2 py-6px px-3 border-0 d-flex align-items-center">
                    <div className="flex-1 text-body text-opacity-75">
                    ...
                    <div className="dropdown position-relative z-3">
                      <a
                        ...
                        className="link-secondary opacity-50 d-none hover-show-elm"
                      >
        ...
        <div className="flex-1 d-flex flex-column h-100 mw-100">
          <div className="flex-1 overflow-hidden w-100 h-100">
            <PerfectScrollbar
              className="h-100 p-2 p-lg-4 tab-content"
              ref={messagesRef}
            >
              <div
                id="aiChatIntro"
                className={
                  (activeTab === "aiChatIntro" ? "show active" : "d-none") +
                  " tab-pane fade px-3 px-lg-4 py-2"
                }
              >
                <div className="fs-1 lh-sm mb-0">
                  <span className="text-body fw-bold">Hello, there</span>
                </div>
                <div className="fs-4 lh-sm text-body text-opacity-75 mb-4">
                ...
                <div className="row g-4">
                  <div className="col-sm-6 col-xl-4">
                    <a
                      href="#/"
                      className="card cursor-pointer h-100 text-decoration-none text-body text-opacity-75"
                      onClick={(e) => {
                        toggleAiTab(
                          e,
                          "aiChatNew",
                          "Suggest hidden gems and must-see spots for my next trip.",
                        );
                      }}
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="fw-500 text-body mb-1">
                          Plan My Adventure
                        </div>
                        <div className="">
                          Suggest hidden gems and must-see spots for my next
                          trip.
                        </div>
                      </div>
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        toggleAiTab(
                          e,
                          "aiChatNew",
                          "Create a concise and professional response for any situation.",
                        );
                      }}
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="">
                          Create a concise and professional response for any
                          situation.
                        </div>
                      </div>
                  ...
                  <div className="col-sm-6 col-xl-4">
                    ...
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="">
                          Break down complex ideas into simple,
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        toggleAiTab(
                          e,
                          "aiChatNew",
                          "Write and troubleshoot code with smart fixes for tricky errors.",
                        );
                      }}
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="">
                          Write and troubleshoot code with smart fixes for
                          tricky errors.
                        </div>
                      </div>
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        toggleAiTab(
                          e,
                          "aiChatNew",
                          "Generate fresh ideas for projects, names, or creative solutions.",
                        );
                      }}
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="">
                          Generate fresh ideas for projects, names, or creative
                          solutions.
                        </div>
                      </div>
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        toggleAiTab(
                          e,
                          "aiChatNew",
                          "Craft emails, reports, or social posts in a polished, clear tone.",
                        );
                      }}
                    >
                      <div className="card-body p-4">
                        ...
                        <div className="">
                          Craft emails, reports, or social posts in a polished,
                          clear tone.
                        </div>
                      </div>
              ...
              <div
                id="aiChatPrev"
                className={
                  (activeTab === "aiChatPrev" ? "show active" : "d-none") +
                  " tab-pane fade px-sm-3 px-lg-4 py-2"
                }
              >
                ...
                <div className="mb-3">
                  ...
                  <div className="d-flex">
                    ...
                    <div className="d-flex flex-wrap w-100 p-2 opacity-75">
                      <a
                        href="#/"
                        className="link-secondary text-decoration me-2"
                      >
                      ...
                      <a
                        ...
                        className="link-secondary text-decoration me-2"
                      >
                        <i className="far fa-fw fa-thumbs-up"></i>
                      </a>
                      <a
                        href="#/"
                        className="link-secondary text-decoration me-2"
                      >
                        <i className="far fa-fw fa-thumbs-down"></i>
                      </a>
                      <a
                        href="#/"
                        className="link-secondary text-decoration me-2"
                      ...
                      <a href="#/" className="link-secondary text-decoration">
                        <i className="fa fa-fw fa-arrow-rotate-right"></i>
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="d-flex justify-content-start align-items-end">
                    ...
                    <div className="rounded-4 px-3 py-2 bg-inverse bg-opacity-10 text-body mw-75">
                      ...
                      <ol className="my-2 ps-4">
                        <li>
                          Start your day with the perfect brew – 20% off all
                          lattes today!
                        </li>
                        <li>
                          Coffee first, everything else later. Grab your cup
                          now!
                        </li>
                        <li>
                          A little caffeine, a lot of happiness. Visit us for
                          your daily fix!
                        </li>
                      </ol>
              ...
              <div
                id="aiChatNew"
                className={
                  (activeTab === "aiChatNew" ? "show active" : "d-none") +
                  " tab-pane fade px-sm-3 px-lg-4 py-2"
                }
              >
            ...
            <div className="px-lg-4 px-3 pb-3">
              <div className="position-relative mx-lg-4 mx-2 h-100">
                <div className="position-absolute start-0 bottom-0 p-2">
                  <button
                    type="button"
                    className="btn btn-lg px-1 py-1 text-body text-opacity-50"
                  >
                ...
                <input
                  type="text"
                  className="form-control form-control-lg shadow-none rounded-0"
                ...
                <div className="position-absolute end-0 bottom-0 px-2 pb-2">
                  <button
                    ...
                    className="btn btn-lg bg-inverse text-inverse bg-opacity-20 rounded-0"
                  >
