            ...
            <div className="col-xl-9">
              ...
              <div id="formControls" className="mb-5">
                ...
                <p>
                  ...
                  appearance, focus state, sizing, and more. Please read the{" "}
                  <a
                    href="https://getbootstrap.com/docs/5.3/components/forms/"
                    target="_blank"
                    rel="noreferrer"
                  >
              ...
              <div id="readOnly" className="mb-5">
                ...
                <p>
                  ...
                  modification of the input’s value. Read-only inputs appear
              ...
              <div id="readOnlyPlainText" className="mb-5">
                ...
                <p>
                  ...
                  .form-control-plaintext class to remove the default form field
              ...
              <div id="checkboxes" className="mb-5">
                <h4>Checkboxes</h4>
                <p>
                  Default checkboxes are improved upon with the help of{" "}
                  <code>.form-check</code>, a single class for both input types
                ...
                <Card>
                  <CardBody>
                    <div className="row mb-n3">
                      <div className="col-xl-6">
                        <div className="small text-inverse text-opacity-50 mb-1">
              ...
              <div id="radios" className="mb-5">
                <h4>Radios</h4>
                <p>
                  Default radios are improved upon with the help of{" "}
                  <code>.form-check</code>, a single class for both input types
                  that improves the layout and behavior of their HTML elements.
                  You can use Bootstrap custom radio for styled radio button.
                </p>
                <Card>
                  <CardBody>
                    <div className="row mb-n3">
                ...
                <Card>
                  <CardBody>
                    <div className="row">
                      <div className="col-xl-6">
                        <div className="mb-3">
                          <label className="form-label" htmlFor="defaultFile">
                        ...
                        <div className="mb-3">
                          <label className="form-label" htmlFor="multipleFile">
                        ...
                        <div className="mb-3">
                          <label className="form-label" htmlFor="disabledFile">
                            Disabled files input example
                          </label>
                          <input
                            type="file"
                            className="form-control"
                      ...
                      <div className="col-xl-6">
                        <div className="mb-3">
                          <label className="form-label" htmlFor="smFile">
                        ...
                        <div className="mb-3">
                          <label className="form-label" htmlFor="lgFile">
              ...
              <div id="formGrid" className="mb-5">
                <h4>Form grid</h4>
                <p>
                  More complex forms can be built using bootstrap grid classes.
                  Use these for form layouts that require multiple columns,
              ...
              <div id="validation" className="mb-5">
                ...
                <p>
                  ...
                  form validation. Choose from the browser default validation
                  feedback, or implement custom messages with our built-in
                  classes and starter JavaScript.
                </p>
                <Card>
                  <CardBody>
                    <form className="was-validated">
                      <div className="row mb-n3">
                        ...
                        <div className="col-md-6 mb-3">
                          <label
                            htmlFor="validationInvalidInput"
                            className="form-label"
                          >
                            Invalid input
                          </label>
                        ...
                        <div className="col-md-6 mb-3">
                          <label
                            htmlFor="validationInvalidInputGroup"
                            className="form-label"
                          >
                            Input group
                          </label>
                        ...
                        <div className="col-md-6 mb-3">
                          <label
                            htmlFor="validationSelectInvalid"
                            className="form-label"
                          >
                            Select dropdown
                          </label>
                        ...
                        <div className="col-md-6 mb-3">
                          <div className="form-check pt-md-3 mt-md-2">
                            <input
                              ...
                              type="checkbox"
                              id="validationInvalidCheckbox"
                              required
                            />
                            <label
                              className="form-check-label"
                              htmlFor="validationInvalidCheckbox"
                            >
