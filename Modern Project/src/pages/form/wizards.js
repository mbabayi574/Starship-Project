          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="wizardLayout1" className="mb-5">
                ...
                <p>
                  Wizard layout include the number of step and text. Please do
                  note that all the wizard is for uxui ONLY but do not include
                  any javascript or backend logic.
                </p>
                <Card>
                  <CardBody>
                    ...
                    <Card>
                      <CardBody>wizard content here</CardBody>
                    </Card>
                  </CardBody>
