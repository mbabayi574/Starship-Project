...
function FormPlugins() {
  ...
  var minDateRange = (current) => {
    return current.isAfter(minYesterday);
  };
  var maxDateRange = (current) => {
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="reactDatetime" className="mb-5">
                ...
                <p>
                  A date and time picker in the same React.js component. It can
                  be used as a datepicker, timepicker or both at the same time.
                  It is highly customizable and it even allows to edit date's
                  milliseconds. Please read the{" "}
                  <a
                            ...
                            <div className="row gx-2">
                              <div className="col-6">
                                <DateTime
                                  ...
                                  inputProps={{ placeholder: "Min Date" }}
                                  closeOnSelect={true}
              ...
              <div id="reactSelect" className="mb-5">
                ...
                <p>
                  ...
                  multiselect, autocomplete, async and creatable support. Please
                  read the{" "}
                  <a
                    ...
                    <form>
                      <div className="row">
                        ...
                        <div className="col-xl-6">
                          <div className="mb-3">
                            <label className="form-label">
                              Multi <span className="text-danger">*</span>
                            </label>
                            <Select
              ...
              <div id="reactDatepicker" className="mb-5">
                ...
                <p>
                  A simple and reusable datepicker component for React. Please
                  read the{" "}
                  <a
              ...
              <div id="reactColor" className="mb-5">
                ...
                <p>
                  ...
                  Github, Twitter, Material Design & more. Please read the{" "}
                  <a
                          ...
                          <div className="mb-3">
                            ...
                            <div className="input-group">
                              <input
                                ...
                                className="form-control"
                                readOnly
                                value={sketchBackgroundColor}
                              />
                              <div className="dropdown-menu dropdown-menu-end p-0 border-0">
                                <SketchPicker
                                  color={sketchBackgroundColor}
                                  onChangeComplete={handleSketchChangeComplete}
                                />
                              </div>
                              <span
                          ...
                          <div className="mb-3">
                            ...
                            <div className="input-group">
                              <input
                                ...
                                className="form-control"
                                readOnly
                                value={chromeBackgroundColor}
                              />
                              <div className="dropdown-menu dropdown-menu-end p-0 border-0">
                                <ChromePicker
                                  color={chromeBackgroundColor}
                                  onChangeComplete={handleChromeChangeComplete}
                                />
                              </div>
                              <span
                                className="input-group-text"
              ...
              <div id="reactTagInputComponent" className="mb-5">
                ...
                <p>
                  A lightweight component for tag(s) input. Please read the{" "}
                  <a
                    href="https://github.com/hc-oss/react-tag-input-component"
                    target="_blank"
                    rel="noreferrer"
                  >
                    official documentation
              ...
              <div id="reactQuill" className="mb-5">
                <h4>React Quill</h4>
                <p>
                  A Quill component for React. Please read the{" "}
                  <a
                    href="https://github.com/hc-oss/react-tag-input-component"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div id="reactDateRangePicker" className="mb-5">
                ...
                <p>
                  A date/time picker for react (using bootstrap). Please read
                  the{" "}
                  <a
                    href="https://github.com/skratchdot/react-bootstrap-daterangepicker"
                    target="_blank"
                    rel="noreferrer"
                  >
                    official documentation
                  ...
                  <CardBody className="pb-2">
                    <div className="mb-3">
                      ...
                      <div className="d-sm-flex align-items-center mb-3">
                        ...
                        <div>
                          compared to <span>{dateRangePrevWeek}</span>
                        </div>
                      </div>
                    </div>
                  </CardBody>
