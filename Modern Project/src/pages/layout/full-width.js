...
function LayoutFullWidth() {
  ...
  return (
    <div>
      ...
      <p>Below is the example for how to setup a full width page</p>
      ...
      <p>
        <button onClick={handleBackBtn} className="btn btn-outline-theme">
          <i className="bi bi-chevron-left fa-fw ms-n1"></i> Back to previous
          Page
        </button>
      </p>
    </div>
