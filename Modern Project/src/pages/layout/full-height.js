...
function LayoutFullHeight() {
  ...
  useEffect(() => {
    fetch("/assets/data/layout/full-height-code-1.json")
  ...
  return (
    <div>
      ...
      <p>Below is the example for how to setup a full height page</p>
      ...
      <div className="pb-5">
        ...
        <i className="bi bi-chevron-down text-theme"></i>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
