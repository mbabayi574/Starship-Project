                      ...
                      <div className="col-xl-6">
                        <Card>
                          ...
                          <CardBody>
                            ...
                            <h6 className="card-subtitle mb-3 text-inverse text-opacity-50">
                              Card subtitle
                            </h6>
              ...
              <div id="navigation" className="mb-5">
                ...
                <Card>
                  <CardBody>
                    <div className="row">
                      <div className="col-xl-6">
                        <div className="small text-inverse text-opacity-50 mb-3 fw-bold">
                          NAV TABS
                        </div>
                        <Card className="mb-3">
                          <CardHeader>
                    ...
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        <Card className="mb-3">
                          <CardBody className="pb-0">
                            <img
                              src="https://placehold.co/600x400/c9d2e3/212837"
                              alt=""
                      ...
                      <div className="col-xl-6">
                        ...
                        <Card className="p-3 mb-3">
                          <img
                            src="https://placehold.co/600x750/000000/ffffff"
                            alt=""
                            className="card-img"
                          />
                      ...
                      <CardBody>
                        <div className="row gx-0 align-items-center">
                          <div className="col-md-4">
                            <img
                              src="https://placehold.co/480x360/c9d2e3/212837"
                              alt=""
                    ...
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        <Card className="border-theme bg-theme bg-opacity-25 mb-3">
                          <CardHeader className="border-theme fw-bold small text-inverse">
                            HEADER
                          </CardHeader>
                          <CardBody>
                            <h5 className="card-title">Primary card title</h5>
                            <p className="card-text text-inverse text-opacity-75">
                              Some quick example text to build on the card title
                              and make up the bulk of the card's content.
                            </p>
                          </CardBody>
