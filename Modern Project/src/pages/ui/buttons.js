            ...
            <div className="col-xl-9">
              ...
              <div id="classes" className="mb-5">
                ...
                <p>
                  ...
                  for more control. Please read the{" "}
                  <a
                ...
                <Card>
                  <CardBody>
                    ...
                    <hr />
                    <button type="button" className="btn btn-default mb-1 me-1">
                      Default
                    </button>
                    <button
                      type="button"
                    ...
                    <button type="button" className="btn btn-light mb-1 me-1">
                      Light
                    </button>
                    <button type="button" className="btn btn-dark mb-1 me-1">
                      Dark
                    </button>
                    <button type="button" className="btn btn-info mb-1 me-1">
                      Info
                    </button>
                    <button type="button" className="btn btn-primary mb-1 me-1">
                      Primary
                    </button>
                    <button type="button" className="btn btn-purple mb-1 me-1">
                      Purple
                    </button>
                    <button type="button" className="btn btn-indigo mb-1 me-1">
                      Indigo
                    </button>
                    <button type="button" className="btn btn-link mb-1 me-1">
                      Link
                    </button>
                    <span className="d-lg-inline d-none">
                      <br />
                    </span>
                    <button type="button" className="btn btn-danger mb-1 me-1">
                      Danger
                    </button>
                    <button type="button" className="btn btn-pink mb-1 me-1">
                      Pink
                    </button>
                    <button type="button" className="btn btn-warning mb-1 me-1">
                      Warning
                    </button>
                    <button type="button" className="btn btn-yellow mb-1 me-1">
                      Yellow
                    </button>
                    <button type="button" className="btn btn-lime mb-1 me-1">
                      Lime
                    </button>
                    <button type="button" className="btn btn-green mb-1 me-1">
                      Green
                    </button>
                    <button type="button" className="btn btn-success mb-1 me-1">
                      Success
                    </button>
                  </CardBody>
              ...
              <div id="outlineButtons" className="mb-5">
                ...
                <Card>
                  <CardBody>
                    ...
                    <button
                      type="button"
                      className="btn btn-outline-default mb-1 me-1"
                    >
                      Default
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-secondary mb-1 me-1"
                    >
                      Secondary
                    </button>
                    <button
                    ...
                    <button
                      type="button"
                      className="btn btn-outline-dark mb-1 me-1"
                    >
                      Dark
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-info mb-1 me-1"
                    >
                      Info
                    </button>
                    <button
                    ...
                    <button
                      type="button"
                      className="btn btn-outline-purple mb-1 me-1"
                    >
                      Purple
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-indigo mb-1 me-1"
                    >
                      Indigo
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-link mb-1 me-1"
                    >
                      Link
                    </button>
                    <br />
                    ...
                    <button
                      type="button"
                      className="btn btn-outline-pink mb-1 me-1"
                    >
                      Pink
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-warning mb-1 me-1"
                    >
                      Warning
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-yellow mb-1 me-1"
                    >
                      Yellow
                    </button>
                    <button
                    ...
                    <button
                      type="button"
                      className="btn btn-outline-green mb-1 me-1"
                    >
                      Green
                    </button>
                    <button
                      type="button"
                      className="btn btn-outline-success mb-1 me-1"
                    >
                      Success
                    </button>
                  </CardBody>
                ...
                <Card>
                  <CardBody className="pb-0">
                    <div className="mb-4">
                      ...
                      <button
                        type="button"
                        className="btn me-1 btn-outline-theme btn-lg"
                      >
                        Large button
                      </button>
                      <button
                        type="button"
                        className="btn me-1 btn-outline-secondary btn-lg"
                      >
                        Large button
                      </button>
                    </div>
                    <div className="mb-4">
                      ...
                      <button
                        type="button"
                        className="btn me-1 btn-outline-theme btn-sm"
                      >
                        Small button
                      </button>
                      <button
                        type="button"
                        className="btn me-1 btn-outline-secondary btn-sm"
                      >
                        Small button
                      </button>
                    </div>
              ...
              <div id="states" className="mb-5">
                <h4>States</h4>
                <p>
                  Buttons will appear pressed when active or you can still force
                  the same active appearance by adding <code>.active</code>{" "}
                  class. Make buttons look inactive by adding the{" "}
                ...
                <Card>
                  <CardBody className="pb-0">
                    <div className="mb-4">
                      ...
                      <a
                        href="#/"
                        className="btn me-1 btn-outline-theme btn-lg active"
                      >
                        Primary link
                      </a>
                      <a
                        href="#/"
                        className="btn me-1 btn-outline-secondary btn-lg active"
                      >
                        Link
                      </a>
                    </div>
                    <div className="mb-4">
                      ...
                      <button
                        type="button"
                        className="btn me-1 btn-lg btn-outline-theme"
                        disabled
                      >
                        Primary button
                      </button>
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  ...
                  <a className="nav-link" href="#sizes" data-toggle="scroll-to">
                    Sizes
                  </a>
                  <a
                    className="nav-link"
