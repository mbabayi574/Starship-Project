...
function UiBootstrap() {
  ...
  useEffect(() => {
    fetch("/assets/data/ui/bootstrap-code-1.json")
    ...
    fetch("/assets/data/ui/bootstrap-code-2.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-3.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-4.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-5.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-6.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-7.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-8.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-9.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-10.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-11.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/bootstrap-code-12.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="alert" className="mb-5">
                ...
                <p>
                  ...
                  <code>.alert</code> and one of the four contextual classes for
                  basic alert messages. Please read the{" "}
                  <a
                ...
                <Card>
                  <CardBody>
                    ...
                    <div className="alert alert-secondary">
                      <strong>Secondary Alert!</strong> This alert is not
                      important, but it's beautiful.
                    </div>
              ...
              <div id="badge" className="mb-5">
                ...
                <p>
                  ...
                  labeling component. Please read the{" "}
                  <a
              ...
              <div id="carousel" className="mb-5">
                ...
                <p>
                  ...
                  slides of text—like a carousel. Please read the{" "}
                  <a
                    ...
                    >
                      ...
                      <div className="carousel-inner">
                        <div className="carousel-item active">
                          <img
                            src="https://placehold.co/728x400/c9d2e3/212837"
                            alt=""
              ...
              <div id="jumbotron" className="mb-5">
                ...
                <p>
                  ...
                  content by using Bootstrap utilities.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="listGroup" className="mb-5">
                ...
                <p>
                  ...
                  displaying a series of content. Please read the{" "}
                  <a
              ...
              <div id="mediaObject" className="mb-5">
                <h4>Media Object</h4>
                <p>
                  Media object is created by using Bootstrap utilities class and
                  it is construct highly repetitive components like blog
                ...
                <Card>
                  <CardBody>
                    <div className="d-flex align-items-start">
                      <img
                        src="https://placehold.co/128x128/c9d2e3/212837"
                        alt=""
                        width="64"
                        className="rounded"
                      />
              ...
              <div id="navs" className="mb-5">
                ...
                <p>
                  ...
                  Please read the{" "}
                  <a
                    href="https://getbootstrap.com/docs/5.3/components/navs/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    official Bootstrap documentation
                    ...
                    <div className="row">
                      <div className="col-xl-6 mb-xl-0 mb-3">
                        ...
                        <nav className="nav nav-underline mb-3">
                          <a className="nav-link ms-3 active" href="#/">
                            Active
                          </a>
                          ...
                          <a className="nav-link ms-3 disabled" href="#/">
                            Disabled
                          </a>
                        </nav>
                      </div>
              ...
              <div id="navbar" className="mb-5">
                ...
                <p>
                  ...
                  support for collapse plugin. Please read the{" "}
                  <a
                ...
                <Card>
                  <CardBody>
                    <nav
                      className="navbar navbar-expand-lg bg-white mb-3 rounded"
                      data-bs-theme="light"
                    >
                    ...
                    <nav
                      className="navbar navbar-expand-lg bg-gray-900 rounded"
                      data-bs-theme="dark"
                    >
                      <div className="container-fluid">
                        <button
              ...
              <div id="pagination" className="mb-5">
                <h4>Pagination</h4>
                <p>
                  Documentation and examples for showing pagination to indicate
              ...
              <div id="progress" className="mb-5">
                ...
                <p>
                  ...
                  and text labels. Please read the{" "}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#alert" data-toggle="scroll-to">
                    Alert
                  </a>
                  <a className="nav-link" href="#badge" data-toggle="scroll-to">
                    Badge
                  </a>
                  <a
                    className="nav-link"
                  ...
                  <a className="nav-link" href="#navs" data-toggle="scroll-to">
                    Navs
                  </a>
                  <a
                    className="nav-link"
