        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="tabs" className="mb-5">
                ...
                <p>
                  ...
                  generate a tabbed interface. Use them to create tabbable
                  regions with bootstrap tab JavaScript plugin. Please read the{" "}
                  <a
              ...
              <div id="tabsV2" className="mb-5">
                <h4>Tabs v2</h4>
                <p>
                  This is an extended ui layout from default Bootstrap
                  navigation tabs. Add <code>.nav-tabs-v2</code> to the
                  navigation element in order to activate the v2 layout.
                </p>
                <Card>
                  ...
                  <CardBody>
                    ...
                    <div className="tab-content" id="pills-tabContent">
                      ...
                      <div className="tab-pane fade" id="pills-contact">
                        ...
                        ullamco Lorem. Ullamco ut ad minim do mollit labore
                        ipsum laboris ipsum commodo sunt tempor enim incididunt.
                        Commodo quis sunt dolore aliquip aute tempor irure magna
                        enim minim reprehenderit. Ullamco consectetur culpa
                        veniam sint cillum aliqua incididunt velit ullamco sunt
                        ullamco quis quis commodo voluptate. Mollit nulla
                        nostrud adipisicing aliqua cupidatat aliqua pariatur
              ...
              <div id="accordion" className="mb-5">
                ...
                <p>
                  ...
                  Bootstrap Collapse JavaScript plugin. Please read the{" "}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#tabs" data-toggle="scroll-to">
                    Tabs
                  </a>
                  <a
                    className="nav-link"
                  ...
                  <a className="nav-link" href="#pills" data-toggle="scroll-to">
                    Pills
                  </a>
                  <a
                    className="nav-link"
