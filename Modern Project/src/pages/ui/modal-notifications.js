...
function UiModalNotifications() {
  ...
  useEffect(() => {
    fetch("/assets/data/ui/modal-notification-code-1.json")
    ...
    fetch("/assets/data/ui/modal-notification-code-2.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/modal-notification-code-3.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/modal-notification-code-4.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/modal-notification-code-5.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
  ...
  return (
    <div>
              ...
              <div className="col-xl-9">
                ...
                <div id="modal" className="mb-5">
                  ...
                  <p>
                    ...
                    custom content. Please read the{" "}
                    <a
                ...
                <div id="modalCover" className="mb-5">
                  <h4>Modal Cover</h4>
                  <p>
                    Modal cover is an extended feature from Bootstrap modal. It
                    provide the same background color as the modal content.
                    Place a <code>.modal-cover</code> css class on{" "}
                    <code>.modal</code> for full cover modal.
                  </p>
                  <Card>
                    <CardBody>
                      <button
                ...
                <div id="toastsNotification" className="mb-5">
                  ...
                  <p>
                    ...
                    lightweight and easily customizable alert message. Please
                    read the{" "}
                    <a
                ...
                <div id="toastsContainer" className="mb-5">
                  ...
                  <p>
                    Toasts container is an extended ui from Bootstrap toasts.
                    Wrap the toasts with <code>.toasts-container</code> will
                    allow toast to float within the right top position.
                  </p>
                  <Card>
                    <CardBody>
                      <a
      ...
      <div className="toasts-container">
        <div
          className="toast fade hide mb-3"
            ...
            <div className="modal-body">
              ...
              <div className="row mb-5">
                ...
                <div className="col-md-3">
                  <button
                    type="button"
                    className="btn btn-outline-theme btn-lg btn-block"
                  >
                    Continue
                  </button>
                </div>
              ...
              <div className="pt-3">
                <a href="#/" className="text-muted fs-12px">
