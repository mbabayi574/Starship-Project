...
function UiTypography() {
  ...
  useEffect(() => {
    fetch("/assets/data/ui/typography-code-1.json")
    ...
    fetch("/assets/data/ui/typography-code-2.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-3.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-4.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-5.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-6.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-7.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-8.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/typography-code-9.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
            ...
            <div className="col-xl-9">
              ...
              <div id="headings" className="mb-5">
                ...
                <p>
                  ...
                  you want to match the font styling of a heading but cannot use
                  the associated HTML element. Please read the{" "}
                  <a
              ...
              <div id="displayHeadings" className="mb-5">
                ...
                <p>
                  ...
                  out, consider using a display heading—a larger, slightly more
              ...
              <div id="abbreviations" className="mb-5">
                ...
                <p>
                  ...
                  to users of assistive technologies. Add{" "}
                  <code>.initialism</code> to an abbreviation for a slightly
                  smaller font-size.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="unstyledList" className="mb-5">
                ...
                <p>
                  ...
                  list items (immediate children only). This only applies to
                  immediate children list items, meaning you will need to add
                  the class for any nested lists as well.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="descriptionList" className="mb-5">
                ...
                <p>
                  ...
                  terms, you can optionally add a .text-truncate class to
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  ...
                  <a
                    className="nav-link"
                    href="#displayHeadings"
                    data-toggle="scroll-to"
                  >
                    Display headings
                  </a>
                  <a className="nav-link" href="#lead" data-toggle="scroll-to">
                    Lead
                  </a>
                  <a
                    className="nav-link"
                    href="#inlineTextElements"
                    data-toggle="scroll-to"
                  >
