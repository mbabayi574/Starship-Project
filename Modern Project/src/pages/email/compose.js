      ...
      <div className="mailbox">
        <div className="mailbox-toolbar">
          <div className="mailbox-toolbar-item">
            <span className="mailbox-toolbar-text">New Message</span>
          </div>
          <div className="mailbox-toolbar-item">
            <a href="#/" className="mailbox-toolbar-link active">
              Send
            </a>
          </div>
          <div className="mailbox-toolbar-item">
                ...
                >
                  <div className="mailbox-form-header">
                    <div className="row mb-2">
                      <label className="col-form-label w-100px px-2 fw-500 text-lg-end">
                        To:
                      </label>
