            ...
            <div className="row">
              <div className="col-xl-9">
                <div id="general" className="mb-5">
                  <h4>
                    <i className="far fa-user fa-fw text-theme"></i> General
                  </h4>
                  <p>
                    View and update your general account information and
                    settings.
                  </p>
                  <Card>
                ...
                <div id="notifications" className="mb-5">
                  <h4>
                    <i className="far fa-bell fa-fw text-theme"></i>{" "}
                    Notifications
                  </h4>
                  <p>
                    ...
                    <div className="list-group list-group-flush">
                      ...
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          <div>Tags</div>
                          <div className="text-inverse text-opacity-50 d-flex align-items-center">
                            <i className="fa fa-circle fs-8px fa-fw me-1"></i>{" "}
                            Disabled
                          </div>
                        </div>
                        <div>
                ...
                <div id="privacyAndSecurity" className="mb-5">
                  <h4>
                    <i className="far fa-copyright fa-fw text-theme"></i>{" "}
                    Privacy and security
                  </h4>
                  <p>
                    Limit the account visibility and the security settings for
                    your website.
                  </p>
                  <Card>
                    <div className="list-group list-group-flush">
                      ...
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50 d-flex align-items-center">
                            <i className="fa fa-circle fs-8px fa-fw text-muted me-1"></i>{" "}
                            Disabled
                          </div>
                        </div>
                        <div>
                ...
                <div id="payment" className="mb-5">
                  <h4>
                    <i className="far fa-credit-card fa-fw text-theme"></i>{" "}
                    Payment
                  </h4>
                    ...
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">
                            Paypal, Credit Card, Apple Pay, Amazon Pay, Google
                            Wallet, Alipay, Wechatpay
                          </div>
                        </div>
                        <div>
                          <a
                ...
                <div id="shipping" className="mb-5">
                  <h4>
                    <i className="far fa-paper-plane fa-fw text-theme"></i>{" "}
                    Shipping
                  </h4>
                ...
                <div id="mediaAndFiles" className="mb-5">
                  <h4>
                    <i className="far fa-images fa-fw text-theme"></i> Media and
                    Files
                  </h4>
                    ...
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">
                            English (default), Chinese, France, Portuguese,
                            Japense
                          </div>
                        </div>
                        <div>
                ...
                <div id="resetSettings" className="mb-5">
                  <h4>
                    <i className="fa fa-redo fa-fw text-theme"></i> Reset
                    settings
                  </h4>
                    ...
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">
                            This action will clear and reset all the current
                            website setting.
                          </div>
                        </div>
                        <div>
              ...
              <div className="col-xl-3">
                <NavScrollTo>
                  <nav className="nav">
                    ...
                    <a className="nav-link" href="#privacyAndSecurity">
                      Privacy and security
                    </a>
                    ...
                    <a className="nav-link" href="#mediaAndFiles">
                      Media and Files
                    </a>
                    ...
                    <a className="nav-link" href="#resetSettings">
                      Reset settings
                    </a>
                  </nav>
                </NavScrollTo>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="alert bg-inverse bg-opacity-15">
                <b>Please note:</b>
                If you change your name, you can&#39;t change it again for 60
                days. Don&#39;t add any unusual capitalization, punctuation,
