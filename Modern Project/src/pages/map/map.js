            ...
            <div className="col-xl-9">
              ...
              <div id="jsVectorMap" className="mb-5">
                ...
                <p>
                  ...
                  interactive maps and pretty data visualization. Please read
                  the{" "}
                  <a
              ...
              <div id="googleMapReact" className="mb-5">
                ...
                <p>
                  Google Map React is a component written over a small set of
                  the Google Maps API. It allows you to render any React
                  component on the Google Map. Please read the{" "}
                  <a
