    ...
    <div>
      <div className="d-flex align-items-center mb-md-3 mb-2">
        ...
        <div className="ms-auto">
          ...
          >
            <i className="fa fa-plus-circle me-1"></i> Add Task
          </a>
        </div>
      </div>
      ...
      <div className="mb-md-4 mb-3 d-md-flex">
        ...
        <div className="ms-md-4 mt-md-0 mt-2">
          <i className="fa fa-code-branch fa-fw fa-lg me-1 text-theme"></i>{" "}
          1,392 pull request
        </div>
        <div className="ms-md-4 mt-md-0 mt-2">
          <i className="fa fa-users-cog fa-fw fa-lg me-1 text-theme"></i> 52
          participant
        </div>
        <div className="ms-md-4 mt-md-0 mt-2">
          <i className="far fa-clock fa-fw fa-lg me-1 text-theme"></i> 14 day(s)
        </div>
      </div>
            ...
            <div className="list-group list-group-flush">
              <div className="list-group-item d-flex px-3">
                ...
                <div className="flex-fill">
                  ...
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29949 opened yesterday by Terry
                  </div>
                  <div>
                    <span className="badge border border-gray-300 text-inverse text-opacity-50 me-1">
                      docs
                    </span>
                    <span className="badge border border-theme text-theme">
                      feature
                    </span>
                  </div>
                  <hr className="my-3" />
                  <div className="d-flex align-items-center mb-2">
                    <div className="fw-400 me-2">Task (2/3)</div>
                    <div>
                      <a
                        href="#/"
                        className="text-inverse text-opacity-50"
                        data-bs-toggle="collapse"
                        data-bs-target="#todoBoard"
                      >
                        <i className="fa fa-plus-circle"></i>
                      </a>
                    </div>
                    <div
                      className="progress progress-xs w-100px me-2 ms-auto"
                      style={{ height: "6px" }}
                    >
                      <div
                  ...
                  <div className="form-group mb-0 small">
                    <div className="collapse show" id="todoBoard">
                      ...
                      <div className="form-check">
                        ...
                        >
                          integrate jquery autocomplete with ui
                        </label>
                      </div>
                      <div className="form-check">
                        <input
                        ...
                        >
                          backend search return as json data
                        </label>
                      </div>
                    </div>
                  </div>
              ...
              <a
                href="#/"
                className="list-group-item list-group-item-action d-flex ps-3"
              >
                <div className="me-3 pt-1">
                  <i className="far fa-question-circle text-inverse text-opacity-50 fa-fw fa-lg"></i>
                </div>
                <div className="flex-fill">
                  ...
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29919 opened 9 days ago by xMediaKron
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-gray-300 text-inverse text-opacity-50 me-1">
                      build
                    </span>
                    <span className="badge border border-indigo text-indigo">
                      v5
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex-fill">
                  ...
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29916 opened 9 days ago by Wasbbok
                  </div>
                  <div className="mb-1 d-flex align-items-center">
                    ...
                    <div className="widget-user-list">
                      <div className="widget-user-list-item w-30px h-30px">
                        <div className="widget-user-list-link w-30px h-30px">
                          <img src="/assets/img/user/user-1.jpg" alt="" />
                        </div>
                      </div>
                      <div className="widget-user-list-item w-30px h-30px ms-n2">
                        <div className="widget-user-list-link w-30px h-30px">
                      ...
                      <div className="widget-user-list-item w-30px h-30px ms-n2">
                        <div className="widget-user-list-link w-30px h-30px bg-gray-200 text-gray-500 fs-12px fw-400">
                          +2
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="flex-fill">
                  <div className="fw-400">
                    Custom control border color missing on focus
                  </div>
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29796 opened 29 days ago by mdo
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-pink text-pink">
                      docs
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex-fill">
                  ...
                  <div className="mb-2 small text-inverse text-opacity-50">
                    #29919 opened 19 days ago by sean
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-gray-300 text-inverse text-opacity-50 me-1">
                      design
            ...
            <div className="list-group list-group-flush">
              <div className="list-group-item d-flex px-3">
                ...
                <div className="flex-fill">
                  <div className="fw-400 lh-20">
                    HTML5 flexbox old browser compatibility
                  </div>
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29982 handled by Sean
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-indigo text-indigo">
                      enhancement
                  ...
                  <div className="d-flex align-items-center mb-2">
                    <div className="fw-400 me-2">Task (1/2)</div>
                    <div>
                      <a
                        href="#/"
                        className="text-inverse text-opacity-50"
                  ...
                  <div className="form-group mb-1">
                    <div className="collapse show" id="inProgressBoard">
                      <div className="form-check mb-2px">
                        ...
                        >
                          check all browser compatibility for HTML5 flexbox
                        </label>
                      </div>
                      <div className="form-check mb-2px">
                        <input
                        ...
                        >
                          fallback integration by using other display property
                        </label>
                      </div>
                    </div>
                  </div>
              ...
              <div className="list-group-item d-flex px-3">
                ...
                <div className="flex-fill">
                  ...
                  <div className="text-inverse text-opacity-50 mb-2">
                    #29953 handled by Ken
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-gray-300 text-inverse text-opacity-50 me-1">
                      issue
                  ...
                  <hr className="mt-15px mb-15px" />
                  <div className="d-flex align-items-center mb-2">
                    <div className="fw-400 me-2">Task (0/1)</div>
                    <div>
                      <a
                        href="#/"
                        className="text-inverse text-opacity-50"
                  ...
                  <div className="form-group mb-1">
                    <div className="collapse show" id="inProgress2Board">
                      <div className="form-check mb-2px">
                        ...
                        >
                          debug and fix mobile auto close while using GPS issue
                        </label>
                      </div>
                    </div>
                  </div>
          ...
          <Card className="mb-3">
            ...
            <div className="list-group list-group-flush">
              <div className="list-group-item d-flex px-3">
                ...
                <div className="flex-fill">
                  <div className="fw-400">
                    React version missing daterangepicker
                  </div>
                  <div className="small text-inverse text-opacity-50 mb-2">
                    #29930 closed yesterday by Sean
                  </div>
                  <div className="mb-1">
                    <span className="badge border border-gray-300 text-gray-300 me-1">
                      build
                    </span>
                  ...
                  <hr className="my-3" />
                  <div className="d-flex align-items-center mb-2">
                    <div className="fw-400 me-2">Task (3/3)</div>
                    <div>
                      <a
                        href="#/"
                        className="text-inverse text-opacity-50"
                  ...
                  <div className="form-group mb-1">
                    <div className="collapse show" id="completedBoard">
                      ...
                      <div className="form-check mb-2px">
                        ...
                        >
                          backend integration for data filter with daterange
                          input
                        </label>
                      </div>
                    </div>
