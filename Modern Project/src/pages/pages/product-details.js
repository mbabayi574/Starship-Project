            ...
            <CardBody className="card-body pb-2">
              <div className="mb-2">
                <div className="d-block d-lg-flex align-items-center">
                  ...
                  <button
                    type="submit"
                    className="btn btn-outline-default me-2 mb-1 start"
                  >
                  ...
                  <button
                    type="reset"
                    className="btn btn-outline-default me-2 mb-1 cancel"
                  >
                  ...
                  <button
                    type="button"
                    className="btn btn-outline-default me-2 mb-1 delete"
                  >
                  ...
                  <tr>
                    <td className="align-middle">
                      <div className="form-check">
                        <input
                          type="checkbox"
                          name="variant[0][enabled]"
                          id="variant_0_enabled"
                          defaultValue="1"
                          defaultChecked
                    ...
                    <td>
                      <a href="#/" className="btn btn-outline-theme d-block">
                        Upload Image
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td className="align-middle">
                      <div className="form-check">
                        <input
                          type="checkbox"
                          name="variant[1][enabled]"
                          id="variant_1_enabled"
                          defaultValue="1"
                          className="form-check-input"
                        />
                        <label className="form-check-label">&nbsp;</label>
              ...
              <div className="p-3 bg-white bg-opacity-10">
                <div className="form-group mb-0">
                  ...
                  <div className="shipping-container">
                    ...
                    <hr className="mt-2 mb-2" />
                    <div className="row align-items-center">
                      <div className="col-6 pt-1 pb-1">AliExpress</div>
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          <input
                            type="checkbox"
                    ...
                    <hr className="mt-2 mb-2" />
                    <div className="row align-items-center">
                      <div className="col-6 pt-1 pb-1">SaleHoo</div>
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          <input
                            type="checkbox"
                    ...
                    <hr className="mt-2 mb-2" />
                    <div className="row align-items-center">
                      <div className="col-6 pt-1 pb-1">Megagoods</div>
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          <input
                            type="checkbox"
                    ...
                    <hr className="mt-2 mb-2" />
                    <div className="row align-items-center">
                      <div className="col-6 pt-1 pb-1">Wholesale2B</div>
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          <input
                            type="checkbox"
                    ...
                    <hr className="mt-2 mb-2" />
                    <div className="row align-items-center">
                      <div className="col-6 pt-1 pb-1">Sunrise Wholesale</div>
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          <input
                            type="checkbox"
                            ...
                            name="shipping_enable"
                            defaultValue="Sunrise Wholesale"
                          />
                          <label
                            className="form-check-label"
            ...
            <CardBody>
              <div className="d-flex">
                <div className="flex-1 d-flex">
                  <div className="me-2">
                    <i className="fa fa-store fa-lg fa-fw text-inverse text-opacity-50"></i>
                  </div>
                  <div>Online Store</div>
                  <span className="badge bg-inverse bg-opacity-10 text-theme fw-bold fs-12px ms-auto me-2">
                    2025-01-05
                  </span>
                </div>
                <div className="w-50px text-center">
                  <a href="#/" className="text-decoration-none">
                    <i className="bi bi-calendar fa-lg"></i>
                  </a>
                </div>
              </div>
              <hr />
              <div className="d-flex">
                <div className="flex-1 d-flex">
                  <div className="me-2">
                    <i className="fab fa-shopify fa-lg fa-fw text-inverse text-opacity-50"></i>
                  </div>
                  <div>Shopify</div>
                  <span className="badge bg-inverse bg-opacity-10 text-theme fw-bold fs-12px ms-auto me-2">
                    2025-01-05
              ...
              <div className="d-flex">
                <div className="flex-1 d-flex">
                  <div className="me-2">
                    <i className="fab fa-amazon fa-lg fa-fw text-inverse text-opacity-50"></i>
                  </div>
                  <div>
                    <div>Amazon</div>
                    <div className="d-flex mt-1 text-inverse text-opacity-50 small">
                      <div>
                        <i className="fa fa-circle text-warning fs-6px d-block mt-2"></i>
                      </div>
                      <div className="flex-1 ps-2">
                        <div className="mb-2">
                          Amazon is disconnected. Connect your Amazon Seller
                          Central account to continue using this sales channel.
                        </div>
                        <a href="#/">Learn more</a>
                      </div>
                    </div>
                ...
                <div className="w-50px text-center">
                  ...
                  >
                    <i className="bi bi-x-circle-fill fa-lg fa-fw"></i>
                  </a>
                </div>
              </div>
            </CardBody>
              ...
              <div className="mb-0">
                ...
                <div className="input-group">
                  <input
                    type="text"
                    className="form-control"
                    placeholder="Apple store supplies"
                  />
                  <button className="btn btn-outline-secondary">
                    <i className="fa fa-search"></i>
                  </button>
          ...
          <Card className="mb-4">
            ...
            <CardBody>
              <div className="d-flex align-items-center position-relative fw-bold mb-2">
                <span className="position-absolute top-0 bottom-0 start-0 d-flex align-items-center px-10px">
                  <i className="fa fa-search"></i>
                </span>
                <input
                  type="text"
                  className="form-control ps-30px"
                  placeholder="Search for collections"
                />
              </div>
              <p className="mb-0 small text-inverse text-opacity-50">
                <i className="fa fa-question-circle fa-fw"></i> Add this product
                to a collection so it's easy to find in your store.
              </p>
            </CardBody>
          </Card>
          <Card className="mb-4">
