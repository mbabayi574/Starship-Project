        ...
        <div className="coming-soon-content d-flex flex-column">
          <div className="flex-1 mb-3">
            ...
            <p className="mb-4">
              ...
              <br /> It will bring a lot of new features. Stay tuned!
            </p>
            ...
            <div className="mb-1 small text-inverse text-opacity-50">
              * Subscribe and get notified for latest news
            </div>
          </div>
          <div className="text-center small text-inverse text-opacity-50">
            &copy; 2025 SeanTheme Right Reserved
          </div>
        </div>
      </div>
    </div>
