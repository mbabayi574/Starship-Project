        ...
        <div className="messenger-sidebar">
          <div className="messenger-sidebar-header">
            ...
            <div className="position-relative">
              <button type="submit" className="btn position-absolute top-0">
            ...
            <PerfectScrollbar className="h-100">
              <div className="messenger-item">
                <a
                  ...
                  className="messenger-link active"
                >
                  ...
                  <div className="messenger-info">
                    <div className="messenger-name">
                      Mobile App Development Group 10
                    </div>
                    <div className="messenger-text">
                      Roberto says Hey Gabe, can you forward me the meeting
                      notes?
                    </div>
                  </div>
                ...
                >
                  <div className="messenger-media">
                    <img
                      ...
                      alt=""
                      className="mw-100 mh-100 rounded-pill"
                    />
                  </div>
                  <div className="messenger-info">
              ...
              <div className="messenger-item">
                ...
                >
                  ...
                  <div className="messenger-info">
                    ...
                    <div className="messenger-text">
                      <b>Dan:</b> Wow, almost 2,500 members!
                    </div>
                  </div>
                  <div className="messenger-time-badge">
                ...
                >
                  ...
                  <div className="messenger-time-badge">
                    <div className="messenger-time">
                      <i className="bi bi-check2-all"></i> 10:00
                    </div>
                    <div className="messenger-badge empty"></div>
                  </div>
                </a>
              ...
              <div className="messenger-item">
                ...
                >
                  ...
                  <div className="messenger-info">
                    ...
                    <div className="messenger-text">
                      What are we doing for Jen's birthday on Friday?
                    </div>
                  </div>
                  <div className="messenger-time-badge">
        ...
        <div className="messenger-content">
          <div className="messenger-content-header">
            ...
            <div className="messenger-content-header-btn">
              ...
              <span className="dropdown">
                <a href="#/" className="btn btn-link" data-bs-toggle="dropdown">
                ...
                <div className="dropdown-menu fs-11px">
                  ...
                  >
                    <i className="bi bi-pencil-square fs-14px my-n1 me-3 ms-n2"></i>{" "}
                    EDIT
                  </a>
                  <a
                    href="#/"
                    className="dropdown-item d-flex align-items-center"
                  >
                    <i className="bi bi-info-circle fs-14px my-n1 me-3 ms-n2"></i>{" "}
                    INFO
                  </a>
                  <a
                    href="#/"
                    className="dropdown-item d-flex align-items-center"
                  >
                    <i className="bi bi-bell-slash fs-14px my-n1 me-3 ms-n2"></i>{" "}
                    MUTE
                  </a>
                  <a
                    href="#/"
                    className="dropdown-item d-flex align-items-center"
                  >
                    <i className="bi bi-x-circle fs-14px my-n1 me-3 ms-n2"></i>{" "}
                    CLEAR CHAT HISTORY
                  </a>
                  ...
                  >
                    <i className="bi bi-trash fs-14px my-n1 me-3 ms-n2"></i>{" "}
                    DELETE AND LEAVE
                  </a>
                </div>
              </span>
          ...
          <div className="messenger-content-footer">
            <div className="input-group input-group-lg position-relative">
              <button className="btn position-absolute start-0" id="trigger">
              ...
              />
              <button className="btn btn-outline-default" type="button">
