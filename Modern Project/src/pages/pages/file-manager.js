          ...
          <div className="file-manager h-100" id="fileManager">
            <div className="file-manager-toolbar">
              <button type="button" className="btn border-0">
                <i className="bi bi-plus-lg me-1"></i> File
              </button>
              <button type="button" className="btn border-0">
                <i className="bi bi-plus-lg me-1"></i> Folder
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-copy"></i> Copy
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-arrows-move"></i> Move
              </button>
              <button type="button" className="btn border-0">
                <i className="bi me-1 bi-upload"></i> Upload
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-download"></i> Download
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-trash"></i> Delete
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-arrow-clockwise"></i> Restore
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-file-earmark-text"></i> Rename
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-pen"></i> Edit
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-pencil-square"></i> HTML Editor
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-key"></i> Permissions
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-eye"></i> View
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-unlock"></i> Extract
              </button>
              <button type="button" className="btn border-0" disabled>
                <i className="bi me-1 bi-file-earmark-zip"></i> Compress
              </button>
            </div>
            <div className="file-manager-container">
              <div className="file-manager-sidebar">
                <div className="file-manager-sidebar-mobile-toggler">
                  <button
                    type="button"
                    className="btn"
                    data-toggle-className="file-manager-sidebar-mobile-toggled"
                ...
                <div className="file-manager-sidebar-footer">
                  <div className="d-flex align-items-center">
                    <div className="mx-n1">
                      <Icon
                        className="iconify fa-2x text-theme"
              ...
              <div className="file-manager-content d-flex flex-column">
                <div className="mb-0 d-flex flex-wrap text-nowrap px-10px pt-10px pb-0 border-bottom">
                  <button
                    type="button"
                    className="btn btn-sm btn-default me-2 mb-10px px-2"
                  >
                    <i className="fa fa-fw fa-home"></i>
                  </button>
                  <button
                    type="button"
                    className="btn btn-sm btn-default me-2 mb-10px"
                    disabled
                  >
                    ...
                    <table className="table table-striped table-borderless table-sm m-0 text-nowrap small">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="px-10px">Jun 11, 2025, 10:35PM</td>
                        ...
                        <tr>
                          ...
                          <td className="px-10px">4 KB</td>
                          <td className="px-10px">Jun 11, 2025, 10:36PM</td>
                          <td className="px-10px">http:/unix-directory</td>
                          <td className="px-10px border-0">0755</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">4 KB</td>
                          <td className="px-10px">Jun 11, 2025, 10:04PM</td>
                          <td className="px-10px">http:/unix-directory</td>
                          <td className="px-10px border-0">0755</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">4 KB</td>
                          <td className="px-10px">Jun 11, 2025, 10:14PM</td>
                          <td className="px-10px">http:/unix-directory</td>
                          <td className="px-10px border-0">0755</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="px-10px">July 05, 2025, 10:35PM</td>
                        ...
                        <tr>
                          ...
                          <td className="px-10px">July 06, 2025, 1:00PM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">July 01, 2025, 6:59AM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="px-10px">July 05, 2025, 1.59PM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">July 05, 2025, 12.49PM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">July 10, 2025, 10.35AM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">128 KB</td>
                          <td className="px-10px">August 05, 2025, 12.49PM</td>
                          <td className="px-10px">text/html</td>
                          <td className="px-10px border-0">0644</td>
                        </tr>
                        <tr>
                          ...
                          <td className="px-10px">July 05, 2025, 7.39AM</td>
