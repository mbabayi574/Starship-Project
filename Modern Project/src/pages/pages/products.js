      ...
      <div className="d-flex align-items-center mb-3">
        ...
        <div className="ms-auto">
          <a href="#/" className="btn btn-outline-theme">
            <i className="fa fa-plus-circle fa-fw me-1"></i> Add Product
          </a>
        </div>
      </div>
      ...
      <div className="mb-sm-4 mb-3 d-sm-flex">
        ...
        <div className="ms-sm-4 mt-sm-0 mt-2">
          <a
            ...
            className="text-inverse text-opacity-75 text-decoration-none"
          >
            <i className="fa fa-upload fa-fw me-1 text-theme"></i> Import
          </a>
        </div>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <Link
                            ...
                            className="text-inverse text-opacity-75 text-decoration-none"
                          >
                            Eco-friendly fashion, organic cotton, slow fashion
                            polo shirts
                          </Link>
                        </div>
                      </div>
