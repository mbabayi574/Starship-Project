                        ...
                        <Card className="card mb-3">
                          <CardBody>
                            ...
                            <div className="profile-img-list">
                              ...
                              <div className="profile-img-list-item">
                                <a
                            ...
                            <div className="row text-center fw-bold">
                              <div className="col">
                                <a
                                  href="#/"
                                  className="text-inverse text-opacity-50 text-decoration-none d-block p-2"
                                >
                                  <i className="far fa-thumbs-up me-1 d-block d-sm-inline"></i>{" "}
                                  Likes
                                </a>
                              </div>
                              <div className="col">
                                <a
                                  ...
                                  className="text-inverse text-opacity-50 text-decoration-none d-block p-2"
                                >
                                  <i className="far fa-comment me-1 d-block d-sm-inline"></i>{" "}
                                  Comment
                                </a>
                              </div>
                              <div className="col">
                                <a
                                  ...
                                  className="text-inverse text-opacity-50 text-decoration-none d-block p-2"
                                >
                                  <i className="fa fa-share me-1 d-block d-sm-inline"></i>{" "}
                                  Share
                                </a>
                              </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              <div className="flex-fill ps-2">
                                <div className="position-relative d-flex align-items-center">
                                  <input
                                    type="text"
                                    className="form-control rounded-pill bg-inverse bg-opacity-10"
                                  ...
                                  <div className="position-absolute end-0 text-center">
                                    <a
                                      href="#/"
                                      className="text-inverse text-opacity-50 me-2"
                                    >
                                    ...
                                    <a
                                      href="#/"
                                      className="text-inverse text-opacity-50 me-3"
                                    >
                        ...
                        <Card className="mb-3">
                          <CardBody>
                            ...
                            <div className="ratio ratio-16x9">
                              <iframe
                                title="youtube"
                                src="https://www.youtube.com/embed/ChOhcHD8fBA?showinfo=0"
                              ></iframe>
                            </div>
                            <hr className="mb-1" />
                        ...
                        <Card className="mb-3">
                          <CardBody>
                            ...
                            <p>
                              ...
                              elit.
                              <br />
                              Quisque sodales urna justo, ac ultrices magna
                              consectetur id.
                              <br />
                              <br />
                              Donec tempor ligula sit amet nunc porta, sed
                              aliquam leo sagittis.
                              <br />
                              Ut auctor congue efficitur. Praesent aliquam
                              pulvinar neque, placerat semper massa elementum
                              et.
                            </p>
                            <hr className="mb-1" />
                        ...
                        <div className="list-group list-group-flush">
                          ...
                          <div className="list-group-item px-3">
                            <div className="text-inverse text-opacity-50">
                              <small>
                                <strong>Trending Worldwide</strong>
                              </small>
                            </div>
                              ...
                              <CardBody>
                                <div className="row no-gutters">
                                  <div className="col-md-8">
                                    <div className="small text-inverse text-opacity-50 mb-1 mt-n1">
                                      Space
                                    </div>
                                    <div className="h-40px fs-13px overflow-hidden mb-n1">
                                  ...
                                  <div className="col-md-4 d-flex">
                                    <div
                                      ...
                                      style={{
                                        background:
                                          "url(assets/img/gallery/news-1.jpg) center",
                            ...
                            <div>
                              <small className="text-inverse text-opacity-50">
                                1.89m share
                              </small>
                            </div>
                          </div>
                          <div className="list-group-item px-3">
                            ...
                            <div className="fs-13px mb-1">
                              Be a good Troll and spread some positivity on HUD
                              today.
                            </div>
                            <div>
                              <small className="text-inverse text-opacity-50">
                                <i className="fa fa-external-link-square-alt"></i>{" "}
                                Promoted by HUD Trolls
                              </small>
                            </div>
                          </div>
                          <div className="list-group-item px-3">
                            ...
                            <div className="fs-13px mb-1">
                              The coronavirus is affecting 210 countries around
                              the world and 2 ...
                            </div>
                            <div>
                              <small className="text-inverse text-opacity-50">
                          ...
                          <div className="list-group-item px-3">
                            <div className="text-inverse text-opacity-50">
                              <small>
                                <strong>Trending in New York</strong>
                              </small>
                            </div>
                            ...
                            <Card className="mb-1 text-inverse text-decoration-none">
                              <CardBody>
                                <div className="row no-gutters">
                                  <div className="col-md-8">
                                    <div className="fs-12px text-inverse text-opacity-50 mt-n1">
                                      Coronavirus
                                    </div>
                                    <div className="h-40px fs-13px overflow-hidden mb-n1">
                                      Coronavirus: US suspends travel from
                                      Europe
                                    </div>
                                  </div>
                                  <div className="col-md-4 d-flex">
                                    <div
                                      ...
                                      style={{
                                        background:
                                          "url(assets/img/gallery/news-2.jpg) center",
                                        backgroundSize: "cover",
                                      }}
                                    ></div>
                                  </div>
