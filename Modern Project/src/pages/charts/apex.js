...
function ChartApex() {
  ...
  const [bubbleChartOptions, setBubbleChartOptions] = useState(
  ...
  const [radialBarChartOptions, setRadialBarChartOptions] = useState(
  ...
  var bubbleChartData = [
    {
      name: "Bubble1",
      data: generateBubbleChartData(new Date("11 Feb 2025 GMT").getTime(), 20, {
        min: 10,
        max: 60,
      }),
    },
  ...
  function getMixedChartOptions() {
    ...
    return {
      ...
      xaxis: {
        categories: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2023, 2025],
        axisBorder: {
          show: true,
          color: gray300,
          height: 1,
  ...
  function getCandlestickChartOptions() {
    ...
    var borderColor = getComputedStyle(document.body)
      .getPropertyValue("--bs-border-color")
      .trim();
    var success = getComputedStyle(document.body)
      .getPropertyValue("--bs-success")
      .trim();
    var danger = getComputedStyle(document.body)
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="apexChart">
                <h4>Basic Example</h4>
                <p>
                  Apexcharts.js is a modern javaScript charting library to build
                  interactive charts and visualizations with simple API. Please
                  read the{" "}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  ...
                  <a
                    className="nav-link"
                    href="#apexChartCandlestickChart"
                    data-toggle="scroll-to"
                  >
                    {" "}
                    - candlestick chart
