            ...
            <div className="col-xl-9">
              ...
              <div id="basicTable" className="mb-5">
                ...
                <p>
                  ...
                  tables look in Bootstrap. You can also invert the colors—with
                  light text on dark backgrounds—with <code>.table-dark</code>.
                </p>
                <Card>
                  <CardBody>
                    <div className="row mb-n3">
                      <div className="col-xl-6">
                        <div className="small text-inverse text-opacity-50 mb-3">
                          <b>DEFAULT TABLE</b>
                        </div>
